/*
* audio_pcm_hifi.h -- ALSA SoC PCM HIFI driver
*
...
struct audio_pcm_runtime_data
{
	...
	enum AUIDO_PCM_STATUS  status;       /* pcm status running or stop */
