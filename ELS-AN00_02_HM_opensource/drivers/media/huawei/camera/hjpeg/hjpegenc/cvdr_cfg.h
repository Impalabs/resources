 ...
 * Description: Declaration of cvdr config.
 * Author: lixiuhua
 * Create: 2017-02-28
 *
...
#ifndef __INCLUDE_CVDR_CFG__
#define __INCLUDE_CVDR_CFG__
...
extern int is_hjpeg_du_allocate_update(void);
extern int dump_cvdr_debug_reg(hjpeg_hw_ctl_t *hw_ctl);
...
#define ALLOCATED_DU_NR_RD_0_UPDATE_1               0xD
...
#define CVDR_AXI_JPEG_VP_WR_DEBUG_25_OFFSET         0x1da4
...
#define CVDR_AXI_JPEG_NR_RD_DEBUG_4_OFFSET          0x1574
...
#define CVDR_AXI_JPEG_VP_WR_DEBUG_30_OFFSET         0x1db8

#define CVDR_AXI_JPEG_LINE_STRIDE_VAL               0x3F
#define CVDR_AXI_JPEG_LINE_START_WSTRB_VAL          0xF

#define CVDR_AXI_JPEG_DEBUG_0                       0x1f40
#define CVDR_AXI_JPEG_DEBUG_15                      0x1f7c
#define CVDR_AXI_JPEG_DEBUG_INTERTVAL               0x4
...
typedef union {
	...
	struct {
		...
		uint32_t stop_enable_du_threshold_reached : 1; /* [16] */
		uint32_t stop_enable_flux_ctrl            : 1; /* [17] */
		uint32_t stop_enable_presure              : 1; /* [18] */
		uint32_t reserved1                        : 5; /* [23..19] */
		uint32_t stop_ok                          : 1; /* [24] */
		uint32_t stop                             : 1; /* [25] */
		uint32_t reserved2                        : 5; /* [30..26] */
		uint32_t prefetch_bypass                  : 1; /* [31] */
	} bits;
...
typedef union {
	...
	struct {
		...
		/* [16] */
		uint32_t nr_rd_stop_enable_du_threshold_reached_1 : 1;
