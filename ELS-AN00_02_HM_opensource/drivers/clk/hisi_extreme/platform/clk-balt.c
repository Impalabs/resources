...
static const struct gate_clock crgctrl_gate_clks[] = {
	...
	{ ACLK_GATE_HSDT1_PCIE1, "aclk_hsdt1_pcie1", "div_hsdt1_pcie1", 0x040, 0x8, ALWAYS_ON,
...
static const struct scgt_clock crgctrl_scgt_clks[] = {
	...
	{ CLKGT_HSDT1_PCIE1, "clkgt_hsdt1_pcie1", "clk_ap_ppll0",
		0x0D4, 4, CLK_GATE_HIWORD_MASK | CLK_GATE_ALWAYS_ON_MASK, "clkgt_hsdt1_pcie1" },
...
static const struct gate_clock hsdtctrl_gate_clks[] = {
	...
	{ PCLK_GATE_PCIE_PHY, "pclk_pcie_phy", "pclk_hsdt0_pcie", 0x010, 0x8, 0,
...
static const char * const clk_hsdt1_eusb_mux_p [] = { "clk_ptp_div", "clk_abb_192" };
...
static const struct gate_clock hsdt1ctrl_gate_clks[] = {
	...
	{ PCLK_GATE_PCIE1_PHY, "pclk_pcie1_phy", "pclk_hsdt1_pcie1", 0x000, 0x1000, 0,
...
static const struct div_clock media2crg_div_clks[] = {
	...
	{ CLK_DIV_ADE_FUNC, "clk_ade_func_div", "clkgt_ade_func",
		0xA0, 0x3f, 64, 1, 0, "clk_ade_func_div" },
...
static const struct mux_clock media2crg_mux_clks[] = {
	...
	{ CLK_ADE_FUNC_MUX, "clkmux_ade_func", clk_ade_func_mux_p,
		ARRAY_SIZE(clk_ade_func_mux_p), 0x84, 0xf00, CLK_MUX_HIWORD_MASK, "clkmux_ade_func" },
...
static const struct dvfs_clock dvfs_clks[] = {
	{ CLK_GATE_EDC0, "clk_edc0", "clk_edc0freq", 20, -1, 3, 1,
		{240000, 400000, 480000}, {0, 1, 2, 3}, 480000, 1, "clk_edc0" },
	{ CLK_GATE_MEDIA_COMMON, "clk_media_common", "clk_media_commonfreq", 34, -1, 3, 1,
		{240000, 400000, 480000}, {0, 1, 2, 3}, 480000, 1, "clk_media_common" },
	{ CLK_GATE_VDEC, "clk_vdec", "clk_vdecfreq", 21, -1, 3, 1,
		{200000, 332000, 415000}, {0, 1, 2, 3}, 415000, 1, "clk_vdec" },
	...
	{ CLK_GATE_ADE_FUNC, "clk_ade_func", "clk_ade_funcfreq", 35, -1, 3, 1,
		{427000, 554000, 640000}, {0, 1, 2, 3}, 640000, 1, "clk_ade_func" },
	...
	{ CLK_GATE_ARPP, "clk_arpp_top", "clk_arpp_topfreq", 44, -1, 3, 1,
		{480000, 554000, 640000}, {0, 1, 2, 3}, 640000, 1, "clk_arpp_top" },
