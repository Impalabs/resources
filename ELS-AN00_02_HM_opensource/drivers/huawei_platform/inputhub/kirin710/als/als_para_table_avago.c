 ...
 */
static apds9251_als_para_table apds_als_para_diff_tp_color_table[] = {
...
static apds9999_als_para_table apds9999_als_para_diff_tp_color_table[] = {
	{OTHER, OTHER, DEFAULT_TPLCD, OTHER,
...
static apds9308_als_para_table g_apds9308_para[] = {
	{ STK, V4, BOE_TPLCD,
...
{
	if (id >= ARRAY_SIZE(g_apds9308_para))
		return NULL;
	return &(g_apds9308_para[id]);
}

apds9308_als_para_table *als_get_apds9308_first_table(void)
{
	return &(g_apds9308_para[0]);
}

uint32_t als_get_apds9308_table_count(void)
{
	return ARRAY_SIZE(g_apds9308_para);
}
