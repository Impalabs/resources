...
extern uint8_t get_no_rpsrc_state(void);
...
extern int tcpm_get_remote_pwr_cap(struct tcpc_device *tcpc_dev,
...
extern int tcpm_dpm_pd_power_swap(struct tcpc_device *tcpc,
	uint8_t role, const struct dpm_tcp_event_cb_data *data);
...
extern int tcpm_dpm_pd_goto_min(struct tcpc_device *tcpc,
	const struct dpm_tcp_event_cb_data *data);
...
extern int tcpm_dpm_pd_request(struct tcpc_device *tcpc,
	int mv, int ma, const struct dpm_tcp_event_cb_data *data);
...
#ifdef CONFIG_HW_USB_PD_REV30
extern int tcpm_dpm_pd_get_source_ext_cap(struct tcpc_device *tcpc,
	const struct dpm_tcp_event_cb_data *data,
	struct pd_source_cap_ext *src_cap_ext);
extern int tcpm_dpm_pd_fast_swap(struct tcpc_device *tcpc,
	uint8_t role, const struct dpm_tcp_event_cb_data *data);
extern int tcpm_dpm_get_pd_status(struct tcpc_device *tcpc,
	const struct dpm_tcp_event_cb_data *data, struct pd_status *status);
extern int tcpm_dpm_get_pps_status(struct tcpc_device *tcpc,
	const struct dpm_tcp_event_cb_data *data,
...
extern int tcpm_dpm_pd_get_country_info(struct tcpc_device *tcpc,
	uint32_t ccdo, const struct dpm_tcp_event_cb_data *data,
...
extern int tcpm_dpm_pd_get_bat_status(struct tcpc_device *tcpc,
	...
	const struct dpm_tcp_event_cb_data *data, uint32_t *bsdo);
...
extern int tcpm_dpm_pd_alert(struct tcpc_device *tcpc,
	uint32_t ado, const struct dpm_tcp_event_cb_data *data);
#endif	/* CONFIG_HW_USB_PD_REV30 */
...
extern int tcpm_dpm_pd_cable_soft_reset(
	struct tcpc_device *tcpc, const struct dpm_tcp_event_cb_data *data);
...
extern int tcpm_dpm_vdm_discover_mode(struct tcpc_device *tcpc,
	uint16_t svid, const struct dpm_tcp_event_cb_data *data);
extern int tcpm_dpm_vdm_enter_mode(struct tcpc_device *tcpc,
	uint16_t svid, uint8_t ops, const struct dpm_tcp_event_cb_data *data);
...
extern int tcpm_set_pd_charge_policy(struct tcpc_device *tcpc,
	uint8_t policy, const struct dpm_tcp_event_cb_data *data);

extern int tcpm_set_pd_charge_policy_default(
	struct tcpc_device *tcpc, uint8_t policy);

extern uint8_t tcpm_inquire_pd_charge_policy(struct tcpc_device *tcpc);
extern uint8_t tcpm_inquire_pd_charge_policy_default(
	struct tcpc_device *tcpc);
...
extern void tcpm_huawei_set_scp_charge_en(struct tcpc_device *tcpc, bool en);
extern bool tcpm_inquire_during_huawei_scp_charge(struct tcpc_device *tcpc);
...
extern int tcpm_set_apdo_charge_policy(
	struct tcpc_device *tcpc, uint8_t policy, int mv, int ma,
	const struct dpm_tcp_event_cb_data *data);
extern int tcpm_inquire_source_apdo(struct tcpc_device *tcpc,
...
static inline uint8_t get_no_rpsrc_state(void)
{
	return 0;
}
#endif	/* TCPC_CLASS_NA */
...
static inline int tcpm_get_remote_pwr_cap(struct tcpc_device *tcpc_dev,
	struct tcpm_remote_power_cap *cap)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}
...
static inline int tcpm_dpm_pd_get_source_ext_cap(struct tcpc_device *tcpc,
	const struct dpm_tcp_event_cb_data *data,
	struct pd_source_cap_ext *src_cap_ext)
{
	return TCPM_ERROR_NO_IMPLEMENT;
...
static inline int tcpm_dpm_get_pd_status(struct tcpc_device *tcpc,
	const struct dpm_tcp_event_cb_data *data, struct pd_status *status)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}

static inline int tcpm_dpm_get_pps_status(struct tcpc_device *tcpc,
	const struct dpm_tcp_event_cb_data *data,
	struct pd_pps_status *pps_status)
{
	return TCPM_ERROR_NO_IMPLEMENT;
...
static inline int tcpm_set_pd_charge_policy(struct tcpc_device *tcpc,
	uint8_t policy, const struct dpm_tcp_event_cb_data *data)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}

static inline int tcpm_set_pd_charge_policy_default(
	struct tcpc_device *tcpc, uint8_t policy)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}

static inline uint8_t tcpm_inquire_pd_charge_policy(
	struct tcpc_device *tcpc)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}

static inline uint8_t tcpm_inquire_pd_charge_policy_default(
	struct tcpc_device *tcpc)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}
...
static inline int tcpm_set_apdo_charge_policy(
	struct tcpc_device *tcpc, uint8_t policy, int mv, int ma,
	const struct dpm_tcp_event_cb_data *data)
{
	return TCPM_ERROR_NO_IMPLEMENT;
...
static inline int tcpm_inquire_source_apdo(struct tcpc_device *tcpc,
	uint8_t apdo_type, uint8_t *cap_i, struct tcpm_power_cap_val *cap)
{
	return TCPM_ERROR_NO_IMPLEMENT;
}
