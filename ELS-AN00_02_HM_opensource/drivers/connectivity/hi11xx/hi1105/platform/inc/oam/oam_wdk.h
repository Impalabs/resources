...
typedef enum {
    ...
    OAM_FILE_ID_ALG_INTF_DET_COMM_C = 1139,
    OAM_FILE_ID_ALG_INTF_DET_COMM_H = 1140,
    ...
    OAM_FILE_ID_WAL_LINUX_VENDOR_C = 1237,
    OAM_FILE_ID_WAL_LINUX_VENDOR_H = 1238,
    OAM_FILE_ID_WAL_LINUX_NETDEV_OPS_C = 1239,
    OAM_FILE_ID_WAL_LINUX_NETDEV_OPS_H = 1240,
    OAM_FILE_ID_WAL_LINUX_CUSTOMIZE_C = 1241,
    OAM_FILE_ID_WAL_LINUX_CUSTOMIZE_H = 1242,
    OAM_FILE_ID_DRIVER_WAL_CONFIG_ALG_CFG_C = 1243,
    OAM_FILE_ID_DRIVER_WAL_CONFIG_ALG_CFG_H = 1244,
    OAM_FILE_ID_ALG_CFG_H = 1245,
    OAM_FILE_ID_WAL_WINDOWS_ATCMDSRV_C = 1246,
    OAM_FILE_ID_WAL_WINDOWS_ATCMDSRV_H = 1247,
    OAM_FILE_ID_WAL_WINDOWS_BRIDGE_C = 1248,
    OAM_FILE_ID_WAL_WINDOWS_BRIDGE_H = 1249,
    OAM_FILE_ID_WAL_WINDOWS_CFG80211_C = 1250,
    OAM_FILE_ID_WAL_WINDOWS_CFG80211_H = 1251,
    OAM_FILE_ID_WAL_WINDOWS_CFGVENDOR_C = 1252,
    OAM_FILE_ID_WAL_WINDOWS_CFGVENDOR_H = 1253,
    OAM_FILE_ID_WAL_WINDOWS_CUSTOMIZE_C = 1254,
    OAM_FILE_ID_WAL_WINDOWS_CUSTOMIZE_H = 1255,
    OAM_FILE_ID_WAL_WINDOWS_EVENT_C = 1256,
    OAM_FILE_ID_WAL_WINDOWS_EVENT_H = 1257,
    OAM_FILE_ID_WAL_WINDOWS_FLOWCTL_C = 1258,
    OAM_FILE_ID_WAL_WINDOWS_FLOWCTL_H = 1259,
    OAM_FILE_ID_WAL_WINDOWS_IOCTL_DEBUG_C = 1260,
    OAM_FILE_ID_WAL_WINDOWS_IOCTL_C = 1261,
    OAM_FILE_ID_WAL_WINDOWS_IOCTL_H = 1262,
    OAM_FILE_ID_WAL_WINDOWS_NETDEV_OPS_C = 1263,
    OAM_FILE_ID_WAL_WINDOWS_NETDEV_OPS_H = 1264,
    OAM_FILE_ID_WAL_WINDOWS_RX_RSP_C = 1265,
    OAM_FILE_ID_WAL_WINDOWS_RX_RSP_H = 1266,
    OAM_FILE_ID_WAL_WINDOWS_SCAN_C = 1267,
    OAM_FILE_ID_WAL_WINDOWS_SCAN_H = 1268,
    OAM_FILE_ID_WAL_WINDOWS_VENDOR_C = 1269,
    OAM_FILE_ID_WAL_WINDOWS_VENDOR_H = 1270,

    /* HMAC */
    OAM_FILE_ID_HMAC_11AX_C = 1293,
    OAM_FILE_ID_HMAC_11AX_H = 1294,
    OAM_FILE_ID_HMAC_SAE_C = 1295,
    OAM_FILE_ID_HMAC_SAE_H = 1296,
    OAM_FILE_ID_HMAC_HT_SELF_CURE_C = 1297,
    OAM_FILE_ID_HMAC_HT_SELF_CURE_H = 1298,
    ...
    OAM_FILE_ID_HISI_CUSTOMIZE_WIFI_HI1103_C = 1393,
    ...
    OAM_FILE_ID_HISI_CUSTOMIZE_WIFI_HI1106_C = 1398,
    OAM_FILE_ID_HISI_CUSTOMIZE_WIFI_HI1106_H = 1399,

    OAM_FILE_ID_HMAC_OPMODE_C = 1400,
    OAM_FILE_ID_HMAC_OPMODE_H = 1401,
    OAM_FILE_ID_HMAC_ARP_PROBE_C = 1402,
    OAM_FILE_ID_HMAC_ARP_PROBE_H = 1403,
    ...
    OAM_FILE_ID_HMAC_TCP_ACK_BUF_C = 1412,
    OAM_FILE_ID_HMAC_TCP_ACK_BUF_H = 1413,
    OAM_FILE_ID_HMAC_11V_C = 1414,
    OAM_FILE_ID_HMAC_11V_H = 1415,
    OAM_FILE_ID_HMAC_STAT_C = 1416,
    ...
    OAM_FILE_ID_HMAC_DBAC_C = 1422,
    OAM_FILE_ID_HMAC_DBAC_H = 1423,
    OAM_FILE_ID_DRIVER_HMAC_TX_MSDU_DSCR_C = 1424,
    OAM_FILE_ID_DRIVER_HMAC_TX_MSDU_DSCR_H = 1425,
    OAM_FILE_ID_HMAC_WIFI6_SELF_CURE_C     = 1426,
    OAM_FILE_ID_HMAC_WIFI6_SELF_CURE_H     = 1427,
    OAM_FILE_ID_HMAC_TX_COMPLETE_C = 1428,
    OAM_FILE_ID_HMAC_TX_COMPLETE_H = 1429,
    OAM_FILE_ID_HMAC_HOST_TX_DATA_C = 1430,
    OAM_FILE_ID_HMAC_HOST_TX_DATA_H = 1431,
    OAM_FILE_ID_HMAC_HID2D_C = 1432,
    OAM_FILE_ID_HMAC_HID2D_H = 1433,
    OAM_FILE_ID_HMAC_AL_TX_C = 1434,
    OAM_FILE_ID_HMAC_AL_TX_H = 1435,

    /* DMAC */
    OAM_FILE_ID_DMAC_TX_MSDU_DSCR_C = 1436,
    OAM_FILE_ID_DMAC_TX_MSDU_DSCR_H = 1437,
    OAM_FILE_ID_DMAC_OMI_HANDLE_C = 1438,
    OAM_FILE_ID_DMAC_OMI_HANDLE_H = 1439,
    ...
    OAM_FILE_ID_HOST_MAIN_1106_C = 1606,
    OAM_FILE_ID_HOST_MAIN_BISHENG_C = 1607,
    ...
    OAM_FILE_ID_HAL_RF_H = 1668,
    OAM_FILE_ID_HAL_RF_C = 1669,
    ...
    OAM_FILE_ID_OAM_MAIN_WINDOWS_C = 1715,
    OAM_FILE_ID_OAM_NETLINK_WINDOWS_C = 1716,
    ...
    OAM_FILE_ID_OAL_NET_WINDOWS_H = 1820,
    ...
    OAM_FILE_ID_FRW_TASK_WINDOWS_C = 1926,
    OAM_FILE_ID_FRW_EVENT_MAIN_WINDOWS_C = 1927,
    OAM_FILE_ID_OAL_HCC_BUS_WINDOWS_C = 1928,
    OAM_FILE_ID_OAL_HCC_HOST_WINDOWS_C = 1929,
    OAM_FILE_ID_OAL_PCIE_HOST_WINDOWS_C = 1930,
    OAM_FILE_ID_OAL_PCIE_HOST_WINDOWS_H = 1931,
    OAM_FILE_ID_OAL_PCIE_WINDOWS_C = 1932,
    OAM_FILE_ID_OAL_ETE_HOST_WINDOWS_C = 1933,
    OAM_FILE_ID_OAL_UTIL_WINDOWS_H = 1934,
    OAM_FILE_ID_OAL_WINDOWS_H = 1935,
    ...
    OAM_FILE_ID_HAL_CALI_C = 2114,
    OAM_FILE_ID_HAL_CALI_H = 2115,
    ...
    OAM_FILE_ID_HAL_POWER_C = 2125,
    OAM_FILE_ID_HAL_POWER_H = 2126,

    OAM_FILE_ID_HAL_ATE_TEST_C = 2127,
    OAM_FILE_ID_HAL_ATE_TEST_H = 2128,
    OAL_FILE_ID_DRIVER_MAC_HIEX_H = 2129,
    OAL_FILE_ID_DRIVER_MAC_HIEX_C = 2130,
    OAM_FILE_ID_DRIVER_HMAC_HIEX_H = 2131,
    OAM_FILE_ID_DRIVER_HMAC_HIEX_C = 2132,
    OAL_FILE_ID_DRIVER_DMAC_HIEX_H = 2133,
    OAL_FILE_ID_DRIVER_DMAC_HIEX_C = 2134,
    OAL_FILE_ID_MAC_FTM_C = 2135,
    OAL_FILE_ID_MAC_FTM_H = 2136,

    OAM_FILE_ID_SDT_DRV_WINDOWS_C = 2137,
    ...
    OAM_FILE_ID_HISI_INI_C = 2507,
#ifdef HISI_CONN_NVE_SUPPORT
    OAM_FILE_ID_HISI_CONN_NVE_C = 2508,
    OAM_FILE_ID_HISI_CONN_NVE_H = 2509,
    OAM_FILE_ID_HISI_CONN_NVE_INTERFACE_C = 2510,
    OAM_FILE_ID_HISI_CONN_NVE_INTERFACE_H = 2511,
#endif

    OAM_FILE_ID_PLAT_PM_WLAN_WINDOWS_C = 2508,
    OAM_FILE_ID_PLAT_PM_WINDOWS_C = 2509,
    OAM_FILE_ID_WIRELESSTCH_PATCH_C = 2510,
    OAM_FILE_ID_PLAT_MAIN_WINDOWS_C = 2511,
    OAM_FILE_ID_BOARD_HI1103_WINDOWS_C = 2512,
    OAM_FILE_ID_BFGX_EXCEPTION_RST_WINDOWS_C = 2513,
    OAM_FILE_ID_EEPROM_WINDOWS_C = 2514,
    OAM_FILE_ID_EEPROM_WINDOWS_H = 2515,
    OAM_FILE_ID_WIRELESSTCH_PATCH_WINDOWS_C = 2516,
    ...
    /* alg rom */
    OAM_FILE_ID_ALG_MAIN_ROM_C = 2800,
    OAM_FILE_ID_ALG_AUTORATE_LOG_ROM_C = 2801,
    OAM_FILE_ID_ALG_AUTORATE_ROM_C = 2802,

#ifdef _PRE_WLAN_FEATURE_APF
    OAM_FILE_ID_DMAC_APF_C = 2805,
    OAM_FILE_ID_DMAC_APF_H = 2806,
#endif
    OAM_FILE_ID_OAML_QUEUE_H = 2807,
    OAM_FILE_ID_MAC_COMMON_H = 2808,
    OAM_FILE_ID_HAL_COMMON_H = 2809,
    OAM_FILE_ID_DMAC_MCM_C = 2810,
    OAM_FILE_ID_DMAC_MCM_H = 2811,
    OAM_FILE_ID_HAL_DFT_H = 2812,
    OAM_FILE_ID_HAL_DFT_C = 2813,
    OAM_FILE_ID_HAL_DEV_C = 2814,
    OAM_FILE_ID_HAL_DEV_H = 2815,
    OAM_FILE_ID_HAL_RING_C = 2816,
    OAM_FILE_ID_HAL_HOST_DSCR_C = 2817,
    OAM_FILE_ID_HAL_HOST_MAC_C = 2818,

    OAM_FILE_ID_WLAN_CHIP_C = 2819,
    OAM_FILE_ID_WLAN_CHIP_1103_C = 2820,
    OAM_FILE_ID_WLAN_CHIP_1106_C = 2821,
    OAM_FILE_ID_HMAC_MBO_C = 2822,
    OAM_FILE_ID_HMAC_MBO_H = 2823,
    OAM_FILE_ID_HMAC_VOWIFI_C = 2824,
    OAM_FILE_ID_HMAC_VOWIFI_H = 2825,
    OAM_FILE_ID_WAL_CFG_IOCTL_C = 2826,
    OAM_FILE_ID_HMAC_PACKAGE_PARAMS_C = 2827,
    OAM_FILE_ID_MAC_MIB_C = 2828,
    OAM_FILE_ID_MAC_MIB_H = 2829,
    OAM_FILE_ID_HMAC_SOFT_RETRY_C = 2830,
    OAM_FILE_ID_HMAC_SOFT_RETRY_H = 2831,
    OAM_FILE_ID_HMAC_TID_C = 2832,
    OAM_FILE_ID_HMAC_TID_H = 2833,
    OAM_FILE_ID_HMAC_11K_C = 2834,
    OAM_FILE_ID_HMAC_11K_H = 2835,
    OAM_FILE_ID_HMAC_OTA_REPORT_C = 2836,
    OAM_FILE_ID_HMAC_OTA_REPORT_H = 2837,
    OAM_FILE_ID_HMAC_11W_C = 2838,
    OAM_FILE_ID_HMAC_11W_H = 2839,
    OAM_FILE_ID_HMAC_MULTI_NETBUF_AMSDU_C = 2840,
    OAM_FILE_ID_HMAC_MULTI_NETBUF_AMSDU_H = 2841,
    OAM_FILE_ID_HMAC_MONITOR_C = 2842,
    OAM_FILE_ID_HMAC_MONITOR_H = 2843,
    OAM_FILE_ID_HMAC_NRCOEX_C = 2844,
    OAM_FILE_ID_HMAC_NRCOEX_H = 2845,
    OAM_FILE_ID_HMAC_MGMT_JOIN_C = 2846,
    OAM_FILE_ID_HMAC_MGMT_JOIN_H = 2847,
    OAM_FILE_ID_HMAC_HOST_RX_C = 2848,
    OAM_FILE_ID_HMAC_HOST_RX_H = 2849,
    OAM_FILE_ID_WAL_CONFIG_BASE_C = 2850,
    OAM_FILE_ID_WAL_CONFIG_BASE_H = 2851,
    OAM_FILE_ID_HMAC_ROAM_SCAN_C = 2852,
    OAM_FILE_ID_HMAC_ROAM_SCAN_H = 2853,
    OAM_FILE_ID_HMAC_CALI_ARR_INIT_C = 2854,
    OAM_FILE_ID_HMAC_CALI_ARR_INIT_H = 2855,
    OAM_FILE_ID_WAL_LINUX_CFGVENDOR_ATTRIBUTES_H = 2856,
    OAM_FILE_ID_MAC_FRAME_INL_H = 2857,
    OAM_FILE_ID_HAL_COMMON_DESCRIPTOR_H = 2858,
    OAM_FILE_ID_MAC_CFG_H = 2859,
    OAM_FILE_ID_MAC_DFS_H = 2860,
    OAM_FILE_ID_HMAC_CALI_MGMT_DEBUG_C = 2861,
    OAM_FILE_ID_HMAC_CALI_MGMT_DEBUG_H = 2862,
    OAM_FILE_ID_HMAC_CSI_C = 2863,
    OAM_FILE_ID_HAL_CSI_C = 2864,
    OAM_FILE_ID_HMAC_TX_SWITCH_C = 2865,
    OAM_FILE_ID_HMAC_HOST_TIME_C = 2866,
    OAM_FILE_ID_HMAC_HOST_TIME_H = 2867,
    OAM_FILE_ID_HMAC_DEGRADATION_C = 2868,
    OAM_FILE_ID_HMAC_DEGRADATION_H = 2869,
    OAM_FILE_ID_HMAC_MGMT_STA_UP_C = 2870,
    OAM_FILE_ID_HMAC_MGMT_STA_UP_H = 2871,
    /* dmac是从3000开始的，这里id不能到3000 */
    OAM_FILE_ID_BUTT
} oam_file_id_enum;
typedef uint32_t oam_file_id_enum_uint32;
