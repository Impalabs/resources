 ...
 */
/* 关联用户的最大个数 */
#define WLAN_ASSOC_USER_MAX_NUM 16 /* 1106关联用户的最大个数 */
#define WLAN_ASSOC_USER_MAX_NUM_HI1105 10 /* 1105关联用户的最大个数 10 */
#define WLAN_ASSOC_USER_MAX_NUM_HI1103 10 /* 1103关联用户的最大个数 10 */
...
/*
1106软件规格:P2P_dev/CL以STA模式存在，P2P_GO以AP模式存在，用户数量(组播+单播用户)最大17个,多预留一个备份
    1)AP 模式:  1个组播用户 + 16个单播用户
    2)STA+P2P CL 共存模式:  2个组播用户 + 2个单播用户
    3)STA+P2P GO 共存模式+P2P0:  3个组播用户 + 9个单播用户(STA 1 + GO 8) WLAN_P2P_GO_ASSOC_USER_MAX_NUM_1106
 */
#define WLAN_USER_MAX_USER_LIMIT  18
