...
/* 动态/静态DBDC，其中一个默认使能 */
uint8_t g_wlan_service_device_per_chip[WLAN_SERVICE_DEVICE_MAX_NUM_PER_CHIP] = { WLAN_INIT_DEVICE_RADIO_CAP };
...
/* 为了解各模块的启动时间，增加时间戳打印 */
    ...
    memset_s(g_past_net_device, WLAN_VAP_SUPPORT_MAX_NUM_LIMIT * sizeof(oal_net_device_stru *),
             0, WLAN_VAP_SUPPORT_MAX_NUM_LIMIT * sizeof(oal_net_device_stru *));
#endif
