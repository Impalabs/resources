...
OAL_STATIC oal_uint32 g_schedule_idx = 0;
OAL_STATIC oal_uint32 g_schedule_time[FRW_RX_EVENT_TRACK_NUM] = {0};
OAL_STATIC oal_uint32 g_mac_process_event;  // for debug, adjust the event cnt per frw task scheldued
#endif
