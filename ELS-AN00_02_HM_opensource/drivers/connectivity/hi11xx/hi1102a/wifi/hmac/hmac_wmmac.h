...
extern oal_uint32 hmac_mgmt_rx_addts_rsp(
    hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user, oal_uint8 *puc_payload);
extern oal_uint32 hmac_mgmt_rx_delts(
    hmac_vap_stru *pst_hmac_vap, hmac_user_stru *pst_hmac_user, oal_uint8 *puc_payload);
