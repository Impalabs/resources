                                  ...
                                  oal_uint8 *puc_payload)
{
    ...
    if ((pst_hmac_vap == OAL_PTR_NULL) || (pst_hmac_user == OAL_PTR_NULL) || (puc_payload == OAL_PTR_NULL)) {
        oam_warning_log3(0, OAM_SF_WMMAC, "{hmac_mgmt_rx_addts_rsp::null param, %p %p %p.}", (uintptr_t)pst_hmac_vap,
                              ...
                              oal_uint8 *puc_payload)
{
    ...
    if ((pst_hmac_vap == OAL_PTR_NULL) || (pst_hmac_user == OAL_PTR_NULL) || (puc_payload == OAL_PTR_NULL)) {
        oam_warning_log3(0, OAM_SF_WMMAC, "{hmac_mgmt_rx_delts::null param, %p %p %p.}", (uintptr_t)pst_hmac_vap,
                         (uintptr_t)pst_hmac_user, (uintptr_t)puc_payload);
        return OAL_ERR_CODE_PTR_NULL;
    }
