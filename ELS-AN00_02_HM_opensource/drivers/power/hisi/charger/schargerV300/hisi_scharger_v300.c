 ...
 *
 * Copyright (c) Huawei 2015-2020 Technologies Co., Ltd.
 *
...
static int hi6523_apply_dpm_policy(int vindpm)
{
	...
	params.vterm_vdpm_tbl_len = sizeof(vterm_vdpm) / (sizeof(vterm_vdpm[0]));
...
#define RET_SIZE 16
	...
	ret[15] = hi6523_set_otg_enable(OTG_DISABLE); /* 15: otg_en */
