...
#define HI6421V500_REG_READ(regAddr)             pmic_read_reg(regAddr)
#define HI6421V500_REG_WRITE(regAddr, regval)     pmic_write_reg((int)(regAddr), (int)regval)
#define HI6421V500_REGS_READ(regAddr, buf, size)   pmic_array_read((int)(regAddr), (char*)(buf),(int)(size))
#define HI6421V500_REGS_WRITE(regAddr, buf, size)  pmic_array_write((int)(regAddr), (char*)(buf),(int)(size))
