 ...
 * Description: hi6555v200 coulometer driver headfile
 *
...
#ifdef CONFIG_HISI_HI6556V100_PMU
#define COUL_HARDWARE_VOL_OFFSET_B_ADDR            PMIC_NP_OTP0_45_R_ADDR(0)
#define COUL_HARDWARE_VOL_OFFSET_A_ADDR_0          PMIC_NP_OTP0_45_R_ADDR(0)
#define COUL_HARDWARE_VOL_OFFSET_A_ADDR_1          PMIC_NP_OTP0_46_R_ADDR(0)
#else
...
#define COUL_HARDWARE_OCV_CHOOSE                   PMIC_HRST_REG1_ADDR(0) /* use bit5 */
