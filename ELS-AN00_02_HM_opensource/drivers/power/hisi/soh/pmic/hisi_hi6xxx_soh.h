 ...
 *
 */
#ifndef _HISI_HI6XXX_SOH_H_
#define _HISI_HI6XXX_SOH_H_

#include <linux/bitops.h>
#include <linux/mfd/hisi_pmic.h>
#include <pmic_interface.h>

/* pmic chip diff start */
#ifdef CONFIG_COUL_PMIC6X21V900
/* acr_ocp irq is in pmu irq */
#define ACR_OCP_INT_ADDR      PMIC_SCP_IRQ1_ADDR(0)
#define ACR_OCP_INT_BIT       BIT(PMIC_SCP_IRQ1_discharge_ocp_START)
#define ACR_SOH_IRQ_REG       PMIC_IRQ_MASK_15_ADDR(0)
#define ACR_SOH_INT_MASK_BIT  0xff
#define SOH_OVP_IRQ_MASK_REG  PMIC_IRQ_MASK_15_ADDR(0)
#define SOH_OVL_IRQ_MASK      BIT(7)
#define SOH_OVH_IRQ_MASK      SOH_OVL_IRQ_MASK
#define DCR_FLAG_INT_MASK_REG PMIC_IRQ_MASK_16_ADDR(0)
#define DCR_FLAG_INT_MASK_BIT 0xff
#elif defined(CONFIG_COUL_PMIC6X55V500)
#define ACR_OCP_INT_ADDR      PMIC_IRQ_OCP7_ADDR(0)
#define ACR_OCP_INT_BIT       BIT(PMIC_IRQ_OCP7_irq_discharge_ocp_START)
#define ACR_SOH_IRQ_REG       PMIC_IRQ_MASK_14_ADDR(0)
#define ACR_SOH_INT_MASK_BIT  0xff
#define SOH_OVP_IRQ_MASK_REG  PMIC_IRQ_MASK_14_ADDR(0)
#define SOH_OVL_IRQ_MASK      BIT(7)
#define SOH_OVH_IRQ_MASK      SOH_OVL_IRQ_MASK
#define DCR_FLAG_INT_MASK_REG PMIC_IRQ_MASK_15_ADDR(0)
#define DCR_FLAG_INT_MASK_BIT 0xff
#endif
