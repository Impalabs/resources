 ...
 * Description: hisi_hi6555v300_soh.h
 *
 * pmic soh head file
 *
...
#ifndef _HISI_HI6555V300_SOH_H_
#define _HISI_HI6555V300_SOH_H_
...
#define ACR_OCP_INT_ADDR            PMIC_ACR_SOH_IRQ_ADDR(0)
#define ACR_FLAG_INT_BIT            BIT(PMIC_ACR_SOH_IRQ_acr_flag_START)
#define ACR_OCP_INT_BIT             BIT(PMIC_ACR_SOH_IRQ_discharge_ocp_START)

#define ACR_DATA_L_SHIFT            0
#define ACR_DATA_H_SHIFT            8

#define ACR_SOH_IRQ_REG             PMIC_IRQ_MASK_10_ADDR(0)
...
#define SOH_OVP_IRQ_MASK_REG        PMIC_IRQ_MASK_10_ADDR(0)
