...
STATIC void soh_hi6531_gpio_en(int enable)
{
	...
	usleep_range(25000, 30000); /* 25000: sleep min time us, 30000: sleep max time us */
...
#define hi6531_sysfs_field_rw(_name, r, f) \
	hi6531_sysfs_field(_name, r, f, 0640, hi6531_sysfs_store)
