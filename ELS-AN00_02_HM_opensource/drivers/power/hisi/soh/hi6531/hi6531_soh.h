 ...
 * Description: hi6531_soh.h
 *
 * batt soh hi6531 driver functions.
 *
...
#define hi6531_soh_err(fmt, args...) \
	printk(KERN_ERR    "[hi6531_soh]" fmt, ## args)
#define hi6531_soh_evt(fmt, args...) \
	printk(KERN_WARNING"[hi6531_soh]" fmt, ## args)
#define hi6531_soh_inf(fmt, args...) \
	printk(KERN_INFO   "[hi6531_soh]" fmt, ## args)
#define hi6531_soh_debug(fmt, args...) do {} while (0)
...
#define ACR_UVP_ABS_INT_MASK_BIT \
	BIT(SOC_Hi6531V100_IRQ_MASK_vbat_uvp_abs_mk_START)
#define ACR_OTMP_125_INT_MASK_BIT \
	BIT(SOC_Hi6531V100_IRQ_MASK_thsd_otmp_125_mk_START)
#define ACR_OTMP_140_INT_MASK_BIT \
	BIT(SOC_Hi6531V100_IRQ_MASK_thsd_otmp_140_mk_START)
#define ACR_LDO1_OCP_INT_MASK_BIT  \
	BIT(SOC_Hi6531V100_IRQ_MASK_ldo1_ocp_mk_START)
#define ACR_MASK_ALL_BIT     (ACR_OCP_INT_MASK_BIT | ACR_FLAG_INT_MASK_BIT | \
	ACR_UVP_ABS_INT_MASK_BIT | ACR_OTMP_125_INT_MASK_BIT | \
	ACR_OTMP_140_INT_MASK_BIT | ACR_LDO1_OCP_INT_MASK_BIT)
