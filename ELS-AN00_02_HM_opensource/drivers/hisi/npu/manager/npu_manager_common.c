...
void npu_register_callbak_info_init(void)
{
	...
	for (i = 0; i < NPU_CALLBACK_REG_NUM; i++)
...
EXPORT_SYMBOL(npu_register_callbak_info_init);
...
EXPORT_SYMBOL(npu_open_npu_callback_dereg);
...
EXPORT_SYMBOL(npu_open_npu_callback_proc);
...
EXPORT_SYMBOL(npu_release_npu_callback_reg);
...
EXPORT_SYMBOL(npu_release_npu_callback_dereg);
...
EXPORT_SYMBOL(npu_release_npu_callback_proc);
