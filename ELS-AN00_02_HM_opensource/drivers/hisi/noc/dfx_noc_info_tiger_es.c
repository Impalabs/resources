...
struct noc_mid_info noc_mid_tiger_es[] = {
 ...
 */
const struct noc_busid_initflow dfx_filter_initflow_tiger_es[] = {
...
const struct noc_bus_info noc_buses_info_tiger_es[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_tiger_es,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_tiger_es),
		.p_noc_sec_info = noc_sec_tiger_es,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_tiger_es),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void dfx_noc_get_array_size_tiger_es(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((bus_info_size == NULL) || (dump_list_size == NULL))
		return;

	*bus_info_size = ARRAY_SIZE_NOC(noc_buses_info_tiger_es);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_tiger_es);
}
 ...
 */
unsigned int dfx_noc_clock_enable_tiger_es(struct dfx_noc_device *noc_dev,
