...
struct noc_mid_info noc_mid_tiger[] = {
...
struct noc_sec_info noc_sec_tiger[] = {
...
struct noc_dump_reg noc_dump_reg_list_tiger[] = {
 ...
 */
const struct noc_busid_initflow dfx_filter_initflow_tiger[] = {
...
const struct noc_bus_info noc_buses_info_tiger[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_tiger,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_tiger),
		.p_noc_sec_info = noc_sec_tiger,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_tiger),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void dfx_noc_get_array_size_tiger(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((bus_info_size == NULL) || (dump_list_size == NULL))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_tiger);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_tiger);
}
 ...
 */
unsigned int dfx_noc_clock_enable_tiger(struct dfx_noc_device *noc_dev,
