 ...
 *
 */
#ifndef __DFX_NOC_DUMP_H
#define __DFX_NOC_DUMP_H
...
struct dfx_noc_bus_node_info {
	struct noc_node **noc_node_pptr;
	unsigned int noc_node_idx;
};

/* Stucture For Recording NoC Dump Info. */
struct dfx_noc_dump_info {
	struct dfx_noc_bus_node_info noc_bus_node_info;
	struct dfx_noc_device *noc_device_ptr;
};
