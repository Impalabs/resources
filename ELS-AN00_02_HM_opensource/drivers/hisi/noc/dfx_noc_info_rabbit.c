...
struct noc_mid_info noc_mid_rabbit[] = {
...
struct noc_sec_info noc_sec_rabbit[] = {
...
struct noc_dump_reg noc_dump_reg_list_rabbit[] = {
 ...
 */
const struct noc_busid_initflow dfx_filter_initflow_rabbit[] = {
...
const struct noc_bus_info noc_buses_info_rabbit[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_rabbit,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_rabbit),
		.p_noc_sec_info = noc_sec_rabbit,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_rabbit),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void dfx_noc_get_array_size_rabbit(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((bus_info_size == NULL) || (dump_list_size == NULL))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_rabbit);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_rabbit);
}
 ...
 */
unsigned int dfx_noc_clock_enable_rabbit(struct dfx_noc_device *noc_dev,
