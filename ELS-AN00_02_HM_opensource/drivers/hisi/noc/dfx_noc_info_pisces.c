...
struct noc_mid_info noc_mid_pisces[] = {
...
struct noc_sec_info noc_sec_pisces[] = {
...
struct noc_dump_reg noc_dump_reg_list_pisces[] = {
 ...
 */
const struct noc_busid_initflow dfx_filter_initflow_pisces[] = {
...
const struct noc_bus_info noc_buses_info_pisces[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_pisces,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_pisces),
		.p_noc_sec_info = noc_sec_pisces,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_pisces),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void dfx_noc_get_array_size_pisces(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((bus_info_size == NULL) || (dump_list_size == NULL))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_pisces);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_pisces);
}
 ...
 */
unsigned int dfx_noc_clock_enable_pisces(struct dfx_noc_device *noc_dev,
