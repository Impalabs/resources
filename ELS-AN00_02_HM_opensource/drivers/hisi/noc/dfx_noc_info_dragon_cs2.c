...
static const struct datapath_routid_addr cfgsys_routeid_addr_tbl[] = {
	...
	{0x03, 0x15, 0x0, 0xfa230000},
	{0x03, 0x15, 0x1, 0xfa220000},
...
struct noc_mid_info noc_mid_dragon_cs2[] = {
...
struct noc_sec_info noc_sec_dragon_cs2[] = {
...
struct noc_dump_reg noc_dump_reg_list_dragon_cs2[] = {
 ...
 */
const struct noc_busid_initflow dfx_filter_initflow_dragon_cs2[] = {
...
const struct noc_bus_info noc_buses_info_dragon_cs2[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_dragon_cs2,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_dragon_cs2),
		.p_noc_sec_info = noc_sec_dragon_cs2,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_dragon_cs2),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void dfx_noc_get_array_size_dragon_cs2(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((bus_info_size == NULL) || (dump_list_size == NULL))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_dragon_cs2);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_dragon_cs2);
}

/*
 * dfx__noc_clock_enable - check noc clock state : on or off
 * @noc_dev :noc device poiter
 * @node: noc node poiter
 *
 * If clock enable, return 1, else return 0;
 */
unsigned int dfx_noc_clock_enable_dragon_cs2(struct dfx_noc_device *noc_dev,
