...
typedef union
{
    ...
    struct
    {
        unsigned int usbrefclk_tcxo_en : 1;
        unsigned int usbrefclk_tcxo_drv : 2;
        unsigned int reserved : 13;
        unsigned int peri_ctrl3_msk : 16;
    } reg;
} SOC_PCTRL_PERI_CTRL3_UNION;
#endif
#define SOC_PCTRL_PERI_CTRL3_usbrefclk_tcxo_en_START (0)
#define SOC_PCTRL_PERI_CTRL3_usbrefclk_tcxo_en_END (0)
#define SOC_PCTRL_PERI_CTRL3_usbrefclk_tcxo_drv_START (1)
#define SOC_PCTRL_PERI_CTRL3_usbrefclk_tcxo_drv_END (2)
...
typedef union
{
    ...
    struct
    {
        unsigned int pctrl_mem_sta_sd_modem_5g___low : 32;
    } reg;
} SOC_PCTRL_PERI_STAT43_UNION;
#endif
#define SOC_PCTRL_PERI_STAT43_pctrl_mem_sta_sd_modem_5g___low_START (0)
#define SOC_PCTRL_PERI_STAT43_pctrl_mem_sta_sd_modem_5g___low_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
    struct
    {
        unsigned int pctrl_mem_sta_sd_modem_5g___high : 32;
    } reg;
} SOC_PCTRL_PERI_STAT44_UNION;
#endif
#define SOC_PCTRL_PERI_STAT44_pctrl_mem_sta_sd_modem_5g___high_START (0)
#define SOC_PCTRL_PERI_STAT44_pctrl_mem_sta_sd_modem_5g___high_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
typedef union
{
    ...
    struct
    {
        unsigned int mrb_busy_flag : 29;
        unsigned int reserved : 3;
    } reg;
} SOC_PCTRL_PERI_STAT67_UNION;
#endif
#define SOC_PCTRL_PERI_STAT67_mrb_busy_flag_START (0)
#define SOC_PCTRL_PERI_STAT67_mrb_busy_flag_END (28)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_PCTRL_PERI_STAT69_intr_repair_err_1_START (1)
#define SOC_PCTRL_PERI_STAT69_intr_repair_err_1_END (1)
...
#define SOC_PCTRL_PERI_STAT69_pack_is0_err_1_START (4)
#define SOC_PCTRL_PERI_STAT69_pack_is0_err_1_END (4)
#define SOC_PCTRL_PERI_STAT69_repair_start_point_err_1_START (5)
#define SOC_PCTRL_PERI_STAT69_repair_start_point_err_1_END (5)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_PCTRL_PERI_STAT81_bisr_dbg_info_1_START (0)
#define SOC_PCTRL_PERI_STAT81_bisr_dbg_info_1_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_PCTRL_PERI_STAT82_bisr_dbg_info_1_START (0)
#define SOC_PCTRL_PERI_STAT82_bisr_dbg_info_1_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#endif
#define SOC_PCTRL_PERI_CTRL89_intr_repair_err_msk_START (13)
#define SOC_PCTRL_PERI_CTRL89_intr_repair_err_msk_END (13)
#define SOC_PCTRL_PERI_CTRL89_intr_repair_err_msk_1_START (14)
#define SOC_PCTRL_PERI_CTRL89_intr_repair_err_msk_1_END (14)
#define SOC_PCTRL_PERI_CTRL89_bisr_dbg_sel_START (15)
#define SOC_PCTRL_PERI_CTRL89_bisr_dbg_sel_END (18)
#define SOC_PCTRL_PERI_CTRL89_bisr_dbg_sel_1_START (19)
#define SOC_PCTRL_PERI_CTRL89_bisr_dbg_sel_1_END (22)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
