...
#define PMIC_NP_CLK_TOP_CTRL0_ADDR(base) ((base) + (0x02DFUL))
#define PMIC_CLK_TOP_CTRL1_1_ADDR(base) ((base) + (0x02E0UL))
#define PMIC_NP_CLK_TOP_CTRL1_ADDR(base) ((base) + (0x02E0UL))
...
#define PMIC_NP_BACKUP_CHG_ADDR(base) ((base) + (0x02F2UL))
...
#define PMIC_NP_CLK_TOP_CTRL0_ADDR(base) ((base) + (0x02DF))
#define PMIC_CLK_TOP_CTRL1_1_ADDR(base) ((base) + (0x02E0))
#define PMIC_NP_CLK_TOP_CTRL1_ADDR(base) ((base) + (0x02E0))
...
#define PMIC_NP_BACKUP_CHG_ADDR(base) ((base) + (0x02F2))
