...
#define SOC_USB31_TCA_TCA_CLK_RST_ADDR(base) ((base) + (0x0000UL))
#define SOC_USB31_TCA_TCA_INTR_EN_ADDR(base) ((base) + (0x0004UL))
#define SOC_USB31_TCA_TCA_INTR_STS_ADDR(base) ((base) + (0x0008UL))
#define SOC_USB31_TCA_TCA_GCFG_ADDR(base) ((base) + (0x0010UL))
#define SOC_USB31_TCA_TCA_TCPC_ADDR(base) ((base) + (0x0014UL))
#define SOC_USB31_TCA_TCA_SYSMODE_CFG_ADDR(base) ((base) + (0x0018UL))
#define SOC_USB31_TCA_TCA_CTRLSYNCMODE_CFG0_ADDR(base) ((base) + (0x0020UL))
#define SOC_USB31_TCA_TCA_CTRLSYNCMODE_CFG1_ADDR(base) ((base) + (0x0024UL))
#define SOC_USB31_TCA_TCA_CTRLSYNCMODE_DBG0_ADDR(base) ((base) + (0x0028UL))
#define SOC_USB31_TCA_TCA_CTRLSYNCMODE_DBG1_ADDR(base) ((base) + (0x002CUL))
#define SOC_USB31_TCA_TCA_PSTATE_ADDR(base) ((base) + (0x0030UL))
#define SOC_USB31_TCA_TCA_GEN_STATUS_ADDR(base) ((base) + (0x0034UL))
#define SOC_USB31_TCA_TCA_VBUS_CTRL_ADDR(base) ((base) + (0x0040UL))
#define SOC_USB31_TCA_TCA_VBUS_STATUS_ADDR(base) ((base) + (0x0044UL))
#else
