...
#define RUNTIME_DRG_PARA_ADDR(n) (RUNTIME_VAR_BASE + 0x78 + (n) * 1)
#define DRG_PARA_BIAS(n) (BYTE_REF(RUNTIME_DRG_PARA_ADDR(n)))
#define RUNTIME_TMP_VAR_END (RUNTIME_DRG_PARA_ADDR(4))
...
#define RUNTIME_ARMPC_SR_PARAMETER_ADDR (RUNTIME_SR_VAR_BASE_ADDR + 0xC4)
#define ARMPC_SR_PARAMETER (WORD_REF(RUNTIME_ARMPC_SR_PARAMETER_ADDR))
#define RUNTIME_CLENT_VOTE_TIME_ADDR(n) (RUNTIME_SR_VAR_BASE_ADDR + 0xC8 + (n) * 4)
