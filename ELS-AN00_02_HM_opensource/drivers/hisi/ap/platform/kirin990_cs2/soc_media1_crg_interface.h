...
#define SOC_MEDIA1_CRG_CLKDIV14_ADDR(base) ((base) + (0x098UL))
...
#define SOC_MEDIA1_CRG_INTR_NOCBUS_NONIDLE_PEND_ADDR(base) ((base) + (0x1D0UL))
#define SOC_MEDIA1_CRG_INTR_STAT_NOCBUS_NONIDLE_PEND_ADDR(base) ((base) + (0x1D4UL))
#define SOC_MEDIA1_CRG_DMSS_ASYNC_BRG_ADDR(base) ((base) + (0x1D8UL))
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int reserved_1 : 1;
        unsigned int gt_clk_noc_idi2axi : 1;
...
#define SOC_MEDIA1_CRG_PEREN1_gt_clk_noc_idi2axi_START (3)
#define SOC_MEDIA1_CRG_PEREN1_gt_clk_noc_idi2axi_END (3)
...
#define SOC_MEDIA1_CRG_PERDIS1_gt_clk_noc_idi2axi_START (3)
#define SOC_MEDIA1_CRG_PERDIS1_gt_clk_noc_idi2axi_END (3)
...
#define SOC_MEDIA1_CRG_PERCLKEN1_gt_clk_noc_idi2axi_START (3)
#define SOC_MEDIA1_CRG_PERCLKEN1_gt_clk_noc_idi2axi_END (3)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int reserved_1 : 1;
        unsigned int st_clk_noc_idi2axi : 1;
...
#define SOC_MEDIA1_CRG_PERSTAT1_st_clk_noc_idi2axi_START (3)
#define SOC_MEDIA1_CRG_PERSTAT1_st_clk_noc_idi2axi_END (3)
...
#endif
#define SOC_MEDIA1_CRG_CLKDIV0_sel_jpg_func_pll_START (6)
#define SOC_MEDIA1_CRG_CLKDIV0_sel_jpg_func_pll_END (9)
...
#endif
#define SOC_MEDIA1_CRG_PERI_STAT1_sw_ack_clk_jpg_func_sw_START (0)
#define SOC_MEDIA1_CRG_PERI_STAT1_sw_ack_clk_jpg_func_sw_END (3)
...
typedef union
{
    ...
    struct
    {
        unsigned int vivobus_ddrc0_bypass : 1;
        unsigned int vivobus_ddrc1_bypass : 1;
        ...
        unsigned int vivobus_idi2axi_bypass : 1;
        unsigned int reserved : 14;
        unsigned int vivobus_isp_cpu_per_bypass : 1;
        unsigned int vivo_isp_cfg_bypass : 1;
        unsigned int vivo_ipp_cfg_bypass : 1;
        unsigned int vivo_dss_cfg_bypass : 1;
        unsigned int vivo_vivo2cfg_bypass : 1;
        unsigned int vivo_crg_cfg_bypass : 1;
        unsigned int vivobus_cfg2vivo_bypass : 1;
    } reg;
} SOC_MEDIA1_CRG_PERI_AUTODIV2_UNION;
#endif
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ddrc0_bypass_START (0)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ddrc0_bypass_END (0)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ddrc1_bypass_START (1)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ddrc1_bypass_END (1)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_dss0_bypass_START (2)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_dss0_bypass_END (2)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_dss1_bypass_START (3)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_dss1_bypass_END (3)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_media_com_bypass_START (4)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_media_com_bypass_END (4)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ipp_bypass_START (5)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ipp_bypass_END (5)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_isp_bypass_START (6)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_isp_bypass_END (6)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_isp1_bypass_START (7)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_isp1_bypass_END (7)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ispcpu_bypass_START (8)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ispcpu_bypass_END (8)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ispcpu_wfi_bypass_START (9)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_ispcpu_wfi_bypass_END (9)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_idi2axi_bypass_START (10)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_idi2axi_bypass_END (10)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_isp_cpu_per_bypass_START (25)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_isp_cpu_per_bypass_END (25)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_isp_cfg_bypass_START (26)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_isp_cfg_bypass_END (26)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_ipp_cfg_bypass_START (27)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_ipp_cfg_bypass_END (27)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_dss_cfg_bypass_START (28)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_dss_cfg_bypass_END (28)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_vivo2cfg_bypass_START (29)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_vivo2cfg_bypass_END (29)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_crg_cfg_bypass_START (30)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivo_crg_cfg_bypass_END (30)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_cfg2vivo_bypass_START (31)
#define SOC_MEDIA1_CRG_PERI_AUTODIV2_vivobus_cfg2vivo_bypass_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
