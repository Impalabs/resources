...
subdir-ccflags-y+= -Idrivers/hisi/modem/drv/dt/libfdt/
...
subdir-ccflags-y += -Idrivers/hisi/modem/drv/pinctrl
...
drv-y        += vdev/vdev_msg.o vdev/vdev_atp.o vdev/vdev_hmi.o
endif

ifeq ($(strip $(CFG_CONFIG_USB_RELAY)),YES)
drv-y += usb_relay/bsp_relay.o usb_relay/usb_relay.o
else
drv-y += usb_relay/bsp_relay_stub.o
endif
