...
#define MNTN_AREA_LR_SIZE (1024 * 1392)
#define MNTN_AREA_NR_CCPU_ADDR (MNTN_AREA_LR_ADDR + MNTN_AREA_LR_SIZE)
...
#define MNTN_AREA_LPM3_ADDR (MNTN_AREA_NR_L2HAC_ADDR + MNTN_AREA_NR_L2HAC_SIZE)
