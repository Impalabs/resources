...
#define HIBOOT_UDELAY_COUNTER_BASE 0xe4052000
#define HIBOOT_UDELAY_COUNTER_FREQ 0X19200000
#ifdef CONFIG_USE_TIMER_STAMP
#define HIBOOT_TIMER_BASE 0xF520A000
#define HIBOOT_TIMER_CURRENTVALUE 0x4
#else
#define HIBOOT_TIMER_BASE 0XEDF00000
#define HIBOOT_TIMER_CURRENTVALUE 0x614
#endif
#else
#include <hi_base.h>
