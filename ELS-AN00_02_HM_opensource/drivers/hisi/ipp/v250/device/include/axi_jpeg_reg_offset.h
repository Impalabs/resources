...
#ifndef __AXI_JPEG_REG_OFFSET_CS_H__
#define __AXI_JPEG_REG_OFFSET_CS_H__
...
#define AXI_JPEG_AXI_JPEG_VP_RD_CFG_9_REG       0xB50  /* Video port read Configuration. */
#define AXI_JPEG_AXI_JPEG_VP_RD_LWG_9_REG       0xB54  /* Line width generation. */
#define AXI_JPEG_AXI_JPEG_VP_RD_FHG_9_REG       0xB58  /* Frame height generation. */
#define AXI_JPEG_AXI_JPEG_VP_RD_AXI_FS_9_REG    0xB5C  /* AXI frame start. */
#define AXI_JPEG_AXI_JPEG_VP_RD_AXI_LINE_9_REG  0xB60  /* Line Wrap definition. */
#define AXI_JPEG_AXI_JPEG_VP_RD_IF_CFG_9_REG    0xB64  /* Video port read interface configuration: prefetch or reset or stall capability. */
#define AXI_JPEG_AXI_JPEG_VP_RD_DEBUG_9_REG     0xB6C  /* Video Port Read DEBUG information. */
#define AXI_JPEG_AXI_JPEG_VP_RD_CFG_10_REG      0xB70  /* Video port read Configuration. */
#define AXI_JPEG_AXI_JPEG_VP_RD_LWG_10_REG      0xB74  /* Line width generation. */
#define AXI_JPEG_AXI_JPEG_VP_RD_FHG_10_REG      0xB78  /* Frame height generation. */
#define AXI_JPEG_AXI_JPEG_VP_RD_AXI_FS_10_REG   0xB7C  /* AXI frame start. */
#define AXI_JPEG_AXI_JPEG_VP_RD_AXI_LINE_10_REG 0xB80  /* Line Wrap definition. */
#define AXI_JPEG_AXI_JPEG_VP_RD_IF_CFG_10_REG   0xB84  /* Video port read interface configuration: prefetch or reset or stall capability. */
#define AXI_JPEG_AXI_JPEG_VP_RD_DEBUG_10_REG    0xB8C  /* Video Port Read DEBUG information. */
...
#define AXI_JPEG_AXI_JPEG_LIMITER_VP_RD_9_REG   0x1254 /* Video port read Access limiter. */
#define AXI_JPEG_AXI_JPEG_LIMITER_VP_RD_10_REG  0x1258 /* Video port read Access limiter. */
...
#define IPP_CVDR_AXI_NR_WR_CFG_0_REG            0x1330 /* Initiator write Configuration. */
#define IPP_CVDR_AXI_NR_WR_DEBUG_0_REG          0x1334 /* Non-Raster Write DEBUG information. */
#define IPP_CVDR_AXI_LIMITER_NR_WR_0_REG        0x1338 /* NR WR Access limiter. */
#define AXI_JPEG_AXI_JPEG_NR_WR_CFG_6_REG       0x1390 /* Initiator write Configuration. */
#define AXI_JPEG_AXI_JPEG_NR_WR_DEBUG_6_REG     0x1394 /* Non-Raster Write DEBUG information. */
#define AXI_JPEG_AXI_JPEG_LIMITER_NR_WR_6_REG   0x1398 /* NR WR Access limiter. */
...
#define IPP_CVDR_AXI_NR_RD_CFG_0_REG            0x1530 /* Initiator read Configuration. */
#define IPP_CVDR_AXI_NR_RD_DEBUG_0_REG          0x1534 /* Non-Raster Read DEBUG information. */
#define IPP_CVDR_AXI_LIMITER_NR_RD_0_REG        0x1538 /* NR RD Access limiter. */
#define AXI_JPEG_AXI_JPEG_NR_RD_CFG_3_REG       0x1560 /* Initiator read Configuration. */
#define AXI_JPEG_AXI_JPEG_NR_RD_DEBUG_3_REG     0x1564 /* Non-Raster Read DEBUG information. */
#define AXI_JPEG_AXI_JPEG_LIMITER_NR_RD_3_REG   0x1568 /* NR RD Access limiter. */
...
#endif // __AXI_JPEG_REG_OFFSET_CS_H__
