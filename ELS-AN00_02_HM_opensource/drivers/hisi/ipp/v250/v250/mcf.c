...
{
	union u_mcf_size_cfg tmp_mcf_size_cfg;
...
{
	union u_uv_fsn_get_cand_cfg tmp_mcf_get_cand_cfg;
...
{
	union u_uv_fsn_get_fuv_ratio_cfg tmp_fuvratio_cfg;
	...
	union u_uv_fsn_get_fuv_max_u_diff_cfg tmp_udiff_cfg;
	tmp_udiff_cfg.u32 = 0;
	...
	union u_uv_fsn_get_fuv_max_v_diff_cfg tmp_vdiff_cfg;
	tmp_vdiff_cfg.u32 = 0;
...
{
	union u_uv_fsn_get_conf_cfg tmp_conf_cfg;
	tmp_conf_cfg.u32 = 0;
	...
	union u_uv_fsn_get_conf_max_diff_cfg tmp_maxdiff_cfg;
...
{
	union u_fill_conflict_cfg tmp_fill_conf;
	tmp_fill_conf.u32 = 0;
...
{
	union u_smooth_blend_cfg tmp_sb_cfg;
	tmp_sb_cfg.u32 = 0;
...
{
	union u_smooth_blend_gf_cfg tmp_sb_gf_cfg;
	tmp_sb_gf_cfg.u32 = 0;
...
{
	union u_adjust_color_gf_cfg tmp_adjcol_gf_cfg;
...
{
	union u_adjust_color_get_mask_cfg tmp_adjcol_mask_cfg;
...
{
	union u_adjust_color_get_ratio_cfg tmp_adjcol_ratio_cfg;
