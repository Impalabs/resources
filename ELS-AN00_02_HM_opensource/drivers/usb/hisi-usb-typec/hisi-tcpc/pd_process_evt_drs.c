...
static bool pd_process_ctrl_msg(pd_port_t *pd_port,
		pd_event_t *pd_event)
{
	switch (pd_event->msg) {
...
static bool pd_process_dpm_msg(pd_port_t *pd_port,
		pd_event_t *pd_event)
{
	bool ret = false;
...
bool hisi_pd_process_event_drs(pd_port_t *pd_port, pd_event_t *pd_event)
{
