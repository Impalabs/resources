...
enum pd_pe_state {
	...
	PE_UFP_VDM_DP_STATUS_UPDATE, /* 95 */
	...
	PE_DFP_VDM_MODE_ENTRY_ACKED, /* 110 */
	...
	PE_DFP_VDM_DP_STATUS_UPDATE_NAKED, /* 120 */
...
enum pd_dpm_vdm_request_type {
	PD_DPM_VDM_REQUEST_DISCOVER_ID = PE_DFP_UFP_VDM_IDENTITY_REQUEST,
	PD_DPM_VDM_REQUEST_DISCOVER_SVIDS = PE_DFP_VDM_SVIDS_REQUEST,
	PD_DPM_VDM_REQUEST_DISCOVER_MODES = PE_DFP_VDM_MODES_REQUEST,
	PD_DPM_VDM_REQUEST_ENTRY_MODE = PE_DFP_VDM_MODE_ENTRY_REQUEST,
	PD_DPM_VDM_REQUEST_EXIT_MODE = PE_DFP_VDM_MODE_EXIT_REQUEST,
	PD_DPM_VDM_REQUEST_ATTENTION = PE_UFP_VDM_ATTENTION_REQUEST,

#ifdef CONFIG_USB_PD_ALT_MODE_DFP_SUPPORT
	PD_DPM_VDM_REQUEST_DP_STATUS_UPDATE = PE_DFP_VDM_DP_STATUS_UPDATE_REQUEST,
	PD_DPM_VDM_REQUEST_DP_CONFIG = PE_DFP_VDM_DP_CONFIGURATION_REQUEST,
#endif

#ifdef CONFIG_USB_PD_UVDM_SUPPORT
	PD_DPM_VDM_REQUEST_UVDM = PE_DFP_UVDM_SEND,
#endif
};
...
void hisi_pe_snk_wait_for_capabilities_exit(
		pd_port_t *pd_port, pd_event_t *pd_event);
...
void hisi_pe_snk_transition_to_default_exit(
		pd_port_t *pd_port, pd_event_t *pd_event);
#ifdef CONFIG_USB_PD_REV30
#ifdef CONFIG_USB_PD_REV30_ALERT_REMOTE
...
static inline void hisi_pe_src_give_source_status_entry(pd_port_t *pd_port,
	pd_event_t *pd_event) {}
#endif
#ifdef CONFIG_USB_PD_REV30_PPS_SINK
...
#ifdef CONFIG_USB_PD_SRC_STARTUP_DISCOVER_ID
void hisi_pe_src_vdm_identity_request_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
...
void hisi_pe_src_transition_to_default_exit(
		pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_src_get_sink_cap_exit(pd_port_t *pd_port, pd_event_t *pd_event);
#ifdef CONFIG_USB_PD_REV30
#ifdef CONFIG_USB_PD_REV30_ALERT_LOCAL
static inline void hisi_pe_src_send_source_alert_entry(pd_port_t *pd_port,
		pd_event_t *pd_event) {}
#endif
#ifdef CONFIG_USB_PD_REV30_ALERT_REMOTE
static inline void hisi_pe_src_sink_alert_received_entry(pd_port_t *pd_port,
		pd_event_t *pd_event) {}
#endif
#ifdef CONFIG_USB_PD_REV30_STATUS_REMOTE
...
void hisi_pe_drs_dfp_ufp_change_to_ufp_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_drs_dfp_ufp_send_dr_swap_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
...
void hisi_pe_drs_ufp_dfp_change_to_dfp_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_drs_ufp_dfp_send_dr_swap_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
...
void hisi_pe_prs_snk_src_evaluate_pr_swap_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_prs_snk_src_accept_pr_swap_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_prs_snk_src_transition_to_off_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
...
void hisi_pe_ufp_vdm_get_identity_nak_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
...
void hisi_pe_ufp_vdm_attention_request_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);

#ifdef CONFIG_USB_PD_ALT_MODE_SUPPORT
void hisi_pe_ufp_vdm_dp_status_update_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
...
void hisi_pe_dfp_vdm_mode_entry_request_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_dfp_vdm_mode_entry_acked_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
void hisi_pe_dfp_vdm_mode_entry_naked_entry(
		pd_port_t *pd_port, pd_event_t *pd_event);
