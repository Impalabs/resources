#ifndef _STD_TCPCI_V10_H
#define _STD_TCPCI_V10_H
...
#define TCPC_V10_REG_TX_DATA				0x54

/*
 * TCPC_V10_REG_ALERT
 * TCPC_V10_REG_ALERT_MASK
 */
...
/*
 * TCPC_V10_REG_FAULT_STATUS_MASK
...
/*
 * TCPC_V10_REG_MSG_HDR_INFO
 */
#define TCPC_V10_REG_MSG_HDR_INFO_SET(drole, prole, rev) \
		(((drole) << 3) | ((rev) << 1) | (prole))
