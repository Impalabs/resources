...
#define PHCD_FRAME_NUMBER 123
#define MAX_ENQUEUE_COUNT 1000
...
/*
 * Optional Parameters of PHCD_PORT_STATUS_MASK:
...
/*
 * Optional Parameters of PHCD_PORT_STATUS_CHANGE_MASK:
 * USB_PORT_STAT_C_SUSPEN
