...
/*
 * Fake mmu registers with 16 bytes.
 * Just for ACPU communication with AI CPU by gic.
 */
#define MM_MMU_IDR0 0x0
#define MM_MMU_IDR1 0x4

#define IDR1_ST_X0 0
#define IDR1_ST_X1 0x4

#define MM_MMU_ADDR 0x8
#define MM_MMU_SIZE 0xC

/* module base addr */
#ifndef CONFIG_HISI_SMMUV310
#define MM_TOP_CTL_BASE 0
#define MM_TCU_CACHE_BASE 0x1000
#define HISI_MASTER_0_BASE 0x10000
#define HISI_MASTER_1_BASE 0x14000
#define MM_TCU_PG0_BASE 0x20000
#define MM_TCU_PG1_BASE 0x30000
#define MM_TCU_PG2_BASE 0x40000
#define MM_TCU_PG3_BASE 0x50000
#define MM_TBU_PG0_BASE 0x60000
#define MM_TBU_PG1_BASE 0x70000
#else
#define MM_TOP_CTL_BASE 0x30000
#define MM_TCU_CACHE_BASE 0x31000
#define MM_TCU_PG0_BASE 0x0
#endif
/* TCU CACHE reg */
#define TTW_OPT_FUNC_BYPASS MM_TCU_CACHE_BASE
#define CACHELINE_INV_ALL (MM_TCU_CACHE_BASE + 0x4)
...
#ifndef CONFIG_HISI_SMMUV310
/* TBU reg */
#define SMMU_TBU_CR (MM_TBU_PG0_BASE + 0)
#define TBU_EN_REQ BIT(0)

#define SMMU_TBU_CRACK (MM_TBU_PG0_BASE + 0x4)
...
#define SMMU_TCU_SOFT_RST_STATE0     (MM_TOP_CTL_BASE + 0x28)
#define SMMU_TCU_SOFT_RST_STATE1     (MM_TOP_CTL_BASE + 0x2c)
#define SMMU_TBU_SOFT_RST_STATE0(n)  (MM_TOP_CTL_BASE + 0x30 + (n) * 0x10)
#define SMMU_TBU_SOFT_RST_STATE1(n)  (MM_TOP_CTL_BASE + 0x34 + (n) * 0x10)

#define SMMU_IRPT_MASK_NS (MM_TOP_CTL_BASE + 0x70)
#define TCU_EVENT_TO_MASK BIT(5)
#define SMMU_IRPT_RAW_NS (MM_TOP_CTL_BASE + 0x74)
#define SMMU_IRPT_STAT_NS (MM_TOP_CTL_BASE + 0x78)
#define TCU_EVENT_Q_IRQ BIT(0)
#define TCU_CMD_SYNC_IRQ BIT(1)
#define TCU_GERROR_IRQ BIT(2)
#define SMMU_IRPT_CLR_NS (MM_TOP_CTL_BASE + 0x7c)
...
#define SMMU_IRPT_MASK_S (MM_TOP_CTL_BASE + 0x80)
#define SMMU_IRPT_RAW_S (MM_TOP_CTL_BASE + 0x84)
#define SMMU_IRPT_STAT_S (MM_TOP_CTL_BASE + 0x88)
#define SMMU_IRPT_CLR_S (MM_TOP_CTL_BASE + 0x8c)
#ifdef CONFIG_HISI_SMMUV310
#define SMMU_TCU_CTRL_SCR (MM_TOP_CTL_BASE + 0x90)
#define SMMU_TCU_CTRL_SCR_UARCH_NS (1<<0)
#endif
/* TCU registers */
#define ARM_SMMU_IDR0 (MM_TCU_PG0_BASE + 0x0)
...
#define ARM_SMMU_IDR1 (MM_TCU_PG0_BASE + 0x4)
...
#define ARM_SMMU_IDR2 (MM_TCU_PG0_BASE + 0x4)
#define ARM_SMMU_IDR3 (MM_TCU_PG0_BASE + 0x8)
#define ARM_SMMU_IDR4 (MM_TCU_PG0_BASE + 0xc)
#define ARM_SMMU_IDR5 (MM_TCU_PG0_BASE + 0x14)
...
#define ARM_SMMU_IIDR (MM_TCU_PG0_BASE + 0x18)
#define ARM_SMMU_AIDR (MM_TCU_PG0_BASE + 0x1c)
#define ARM_SMMU_CR0 (MM_TCU_PG0_BASE + 0x20)
#define CR0_CMDQEN BIT(3)
#define CR0_EVTQEN BIT(2)
#define CR0_PRIQEN BIT(1)
#define CR0_SMMUEN BIT(0)

#define ARM_SMMU_CR0ACK (MM_TCU_PG0_BASE + 0x24)

#define ARM_SMMU_CR1 (MM_TCU_PG0_BASE + 0x28)
#define CR1_SH_NSH 0
#define CR1_SH_OSH 2
#define CR1_SH_ISH 3
...
#define ARM_SMMU_CR2 (MM_TCU_PG0_BASE + 0x2c)
#define CR2_PTM BIT(2)
#define CR2_RECINVSID BIT(1)
#define CR2_E2H BIT(0)

#define ARM_SMMU_STATUS (MM_TCU_PG0_BASE + 0x40)
#define ARM_SMMU_GBPA (MM_TCU_PG0_BASE + 0x44)
#define ARM_SMMU_AGBPA (MM_TCU_PG0_BASE + 0x48)
#define ARM_SMMU_IRQ_CTRL (MM_TCU_PG0_BASE + 0x50)
#define IRQ_CTRL_EVTQ_IRQEN BIT(2)
#define IRQ_CTRL_PRIQ_IRQEN BIT(1)
#define IRQ_CTRL_GERROR_IRQEN BIT(0)

#define ARM_SMMU_IRQ_CTRLACK (MM_TCU_PG0_BASE + 0x54)

#define ARM_SMMU_GERROR (MM_TCU_PG0_BASE + 0x60)
...
#define ARM_SMMU_GERRORN (MM_TCU_PG0_BASE + 0x64)

#define ARM_SMMU_GERROR_IRQ_CFG0 (MM_TCU_PG0_BASE + 0x68)
#define ARM_SMMU_GERROR_IRQ_CFG1 (MM_TCU_PG0_BASE + 0x70)
#define ARM_SMMU_GERROR_IRQ_CFG2 (MM_TCU_PG0_BASE + 0x74)

#define ARM_SMMU_STRTAB_BASE (MM_TCU_PG0_BASE + 0x80)
#define STRTAB_BASE_RA BIT(62)
#define STRTAB_BASE_ADDR_SHIFT 6
#define STRTAB_BASE_ADDR_MASK 0x3ffffffffffUL

#define ARM_SMMU_STRTAB_BASE_CFG (MM_TCU_PG0_BASE + 0x88)
...
#define ARM_SMMU_CMDQ_BASE (MM_TCU_PG0_BASE + 0x90)
#define ARM_SMMU_CMDQ_PROD (MM_TCU_PG0_BASE + 0x98)
#define ARM_SMMU_CMDQ_CONS (MM_TCU_PG0_BASE + 0x9c)

#define ARM_SMMU_EVTQ_BASE (MM_TCU_PG0_BASE + 0xa0)
#define ARM_SMMU_EVTQ_PROD (MM_TCU_PG0_BASE + 0x100a8)
#define ARM_SMMU_EVTQ_CONS (MM_TCU_PG0_BASE + 0x100ac)
#define ARM_SMMU_EVTQ_IRQ_CFG0 (MM_TCU_PG0_BASE + 0xb0)
#define ARM_SMMU_EVTQ_IRQ_CFG1 (MM_TCU_PG0_BASE + 0xb8)
#define ARM_SMMU_EVTQ_IRQ_CFG2 (MM_TCU_PG0_BASE + 0xbc)

#define ARM_SMMU_PRIQ_BASE (MM_TCU_PG0_BASE + 0xc0)
#define ARM_SMMU_PRIQ_PROD (MM_TCU_PG0_BASE + 0x100c8)
#define ARM_SMMU_PRIQ_CONS (MM_TCU_PG0_BASE + 0x100cc)
#define ARM_SMMU_PRIQ_IRQ_CFG0 (MM_TCU_PG0_BASE + 0xd0)
#define ARM_SMMU_PRIQ_IRQ_CFG1 (MM_TCU_PG0_BASE + 0xd8)
#define ARM_SMMU_PRIQ_IRQ_CFG2 (MM_TCU_PG0_BASE + 0xdc)
#ifdef CONFIG_HISI_SMMUV310
#define ARM_S_SMMU_TCU_SCR (MM_TCU_PG0_BASE + 0x8e18)
#define ARM_S_SMMU_TCU_INIT (MM_TCU_PG0_BASE + 0x803c)
#define SMMU_TCU_NODE_STATUS (MM_TCU_PG0_BASE + 0x9400)
...
#define CTXDESC_CD_MAX_SSIDS BIT(6)
...
#define MM_SMMU_INVALID_SID 0xff
