 ...
 * Description: hisp config header file.
 * Author: linhengjie
 * Create: 2014-11-11
 *
...
#ifndef __HW_JACKY_KERNEL_CAM_HISP_CFG_H__
#define __HW_JACKY_KERNEL_CAM_HISP_CFG_H__
...
#endif /* __HW_JACKY_KERNEL_CAM_HISP_CFG_H__ */