...
#ifndef _LINUX_HISP_HIPP_H_
#define _LINUX_HISP_HIPP_H_
...
struct hipp_common_s {
	...
	int (*enable_jpgclk)(struct hipp_common_s *drv,
						 unsigned int dvfs);    /* CPE/ORB/JPEGen/JPEGde/FD Clock Enable Handler */
	int (*disable_jpgclk)(struct hipp_common_s *drv,
						  unsigned int dvfs);   /* CPE/ORB/JPEGen/JPEGde/FD Clock Disable Handler */
	...
	unsigned int (*shrf2da)(struct hipp_common_s *drv, unsigned int sharefd,
							unsigned int *size); /* ORB sharefd to va Handler */
	void *comdev;                                       /**/
	void *priv;                                         /**/
