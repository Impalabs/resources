...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_CACHE,              2152*1024,        104*1024,    EMMC_USER_PART},/* cache          104M    p69*/
  {PART_SUPER,              2256*1024,       5600*1024,    EMMC_USER_PART},/* super         5600M    p70*/
  {PART_PRETS,              7856*1024,         24*1024,    EMMC_USER_PART},/* prets           24M    p71*/
  {PART_PRETVS,             7880*1024,          8*1024,    EMMC_USER_PART},/* pretvs           8M    p72*/
  {PART_USERDATA,           7888*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata         4G    p73*/
  #elif defined CONFIG_MARKET_FULL_INTERNAL
  {PART_VERSION,             800*1024,         32*1024,    EMMC_USER_PART},/* version         32M    p65*/
  ...
  {PART_CACHE,              2152*1024,        104*1024,    EMMC_USER_PART},/* cache          104M    p69*/
  {PART_SUPER,              2256*1024,       4720*1024,    EMMC_USER_PART},/* super         4720M    p70*/
  {PART_PRETS,              6976*1024,         24*1024,    EMMC_USER_PART},/* prets           24M    p71*/
  {PART_PRETVS,             7000*1024,          8*1024,    EMMC_USER_PART},/* pretvs           8M    p72*/
  {PART_USERDATA,           7008*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata         4G    p73*/
  ...
  {PART_PREAVS,              936*1024,         32*1024,    EMMC_USER_PART},/* preavs          32M   p66*/
    {PART_SUPER,               968 * 1024,         6988 * 1024,    EMMC_USER_PART}, /* super         6988M    p67 */
    {PART_PRETS,              7956 * 1024,           24 * 1024,    EMMC_USER_PART}, /* prets           24M    p68 */
    {PART_PRETVS,             7980 * 1024,            8 * 1024,    EMMC_USER_PART}, /* pretvs           8M    p69 */
    {PART_CACHE,              7988 * 1024,          104 * 1024,    EMMC_USER_PART}, /* cache          104M    p70 */
    {PART_VERSION,            8092 * 1024,          576 * 1024,    EMMC_USER_PART}, /* version        576M    p71 */
    {PART_PRELOAD,            8668 * 1024,          900 * 1024,    EMMC_USER_PART}, /* preload        900M    p72 */
#ifdef CONFIG_FACTORY_MODE
    {PART_HIBENCH_IMG,        9568 * 1024,          128 * 1024,    EMMC_USER_PART}, /* hibench_img    128M    p73 */
    {PART_HIBENCH_DATA,       9696 * 1024,          512 * 1024,    EMMC_USER_PART}, /* hibench_data   512M    p74 */
    {PART_FLASH_AGEING,      10208 * 1024,          512 * 1024,    EMMC_USER_PART}, /* flash_ageing   512M    p75 */
    {PART_HIBENCH_LOG,       10720 * 1024,           32 * 1024,    EMMC_USER_PART}, /* HIBENCH_LOG    32M     p76 */
    {PART_USERDATA,          10752 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata       4G      p77 */
#else
    {PART_USERDATA,           9568 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata       4G      p73 */
#endif
...
static const struct partition partition_table_ufs[] =
{
  ...
  {PART_CACHE,              2144*1024,         104*1024,    UFS_PART_3},/* cache          104M    p65*/
  {PART_SUPER,              2248*1024,        5600*1024,    UFS_PART_3},/* super         5600M    p66*/
  {PART_PRETS,              7848*1024,          24*1024,    UFS_PART_3},/* prets           24M    p67*/
  {PART_PRETVS,             7872*1024,           8*1024,    UFS_PART_3},/* pretvs           8M    p68*/
  ...
  {PART_CACHE,              2144*1024,         104*1024,    UFS_PART_3},/* cache          104M    p65*/
  {PART_SUPER,              2248*1024,        4720*1024,    UFS_PART_3},/* super         4720M    p66*/
  {PART_PRETS,              6968*1024,          24*1024,    UFS_PART_3},/* prets           24M    p67*/
  {PART_PRETVS,             6992*1024,           8*1024,    UFS_PART_3},/* pretvs           8M    p68*/
  ...
  {PART_PREAVS,              928*1024,          32*1024,    UFS_PART_3},/* preavs         32M     p62*/
    {PART_SUPER,               960 * 1024,          6988 * 1024,    UFS_PART_3}, /* super         6988M    p63 */
    {PART_PRETS,              7948 * 1024,            24 * 1024,    UFS_PART_3}, /* prets           24M    p64 */
    {PART_PRETVS,             7972 * 1024,             8 * 1024,    UFS_PART_3}, /* pretvs           8M    p65 */
    {PART_CACHE,              7980 * 1024,           104 * 1024,    UFS_PART_3}, /* cache          104M    p66 */
    {PART_VERSION,            8084 * 1024,           576 * 1024,    UFS_PART_3}, /* version        576M    p67 */
    {PART_PRELOAD,            8660 * 1024,           900 * 1024,    UFS_PART_3}, /* preload        900M    p68 */
#ifdef CONFIG_FACTORY_MODE
    {PART_HIBENCH_IMG,        9560 * 1024,           128 * 1024,    UFS_PART_3}, /* hibench_img    128M    p69 */
    {PART_HIBENCH_DATA,       9688 * 1024,           512 * 1024,    UFS_PART_3}, /* hibench_data   512M    p70 */
    {PART_FLASH_AGEING,      10200 * 1024,           512 * 1024,    UFS_PART_3}, /* flash_ageing   512M    p71 */
    {PART_HIBENCH_LOG,       10712 * 1024,            32 * 1024,    UFS_PART_3}, /* HIBENCH_LOG     32M    p72 */
    {PART_USERDATA,          10744 * 1024,  (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata         4G    p73 */
#else
    {PART_USERDATA,           9560 * 1024,  (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata         4G    p69 */
#endif
  #endif  /* CONFIG_MARKET_INTERNAL */
#endif  /* CONFIG_NEW_PRODUCT_P */
  {"0", 0, 0, 0},
