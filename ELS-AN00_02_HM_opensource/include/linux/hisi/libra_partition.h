...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_RESERVED8,           682 * 1024,  74 * 1024,    EMMC_USER_PART}, /* reserved8         78M    p51 */
#else
    {PART_ERECOVERY_RAMDISK,   458 * 1024,  32 * 1024,    EMMC_USER_PART}, /* erecovery_ramdisk 32M    p45 */
    ...
    {PART_RESERVED8,           666 * 1024,  90 * 1024,    EMMC_USER_PART}, /* reserved8         94M    p51 */
#endif
    ...
    {PART_RECOVERY_VENDOR,     804 * 1024,  16 * 1024,     EMMC_USER_PART}, /* recovery_vendor  16M    p55 */
    {PART_FW_DTB,              820 * 1024,   2 * 1024,     EMMC_USER_PART}, /* fw_dtb            2M    p56 */
    {PART_DTBO,                822 * 1024,  24 * 1024,     EMMC_USER_PART}, /* dtoimage         24M    p57 */
    {PART_TRUSTFIRMWARE,       846 * 1024,   2 * 1024,     EMMC_USER_PART}, /* trustfirmware    2M     p58 */
    {PART_MODEM_FW,            848 * 1024,  56 * 1024,     EMMC_USER_PART}, /* modem_fw         56M    p59 */
    {PART_ENG_VENDOR,          904 * 1024,  12 * 1024,     EMMC_USER_PART}, /* eng_vendor       12M    p60 */
    {PART_MODEM_PATCH_NV,      916 * 1024,   4 * 1024,     EMMC_USER_PART}, /* modem_patch_nv   4M     p61 */
    {PART_RESERVED4,           920 * 1024,   8 * 1024,     EMMC_USER_PART}, /* reserved4        8M     p62 */
    {PART_RECOVERY_VBMETA,     928 * 1024,   2 * 1024,     EMMC_USER_PART}, /* recovery_vbmeta   2M    p63 */
    {PART_ERECOVERY_VBMETA,    930 * 1024,   2 * 1024,     EMMC_USER_PART}, /* erecovery_vbmeta   2M   p64 */
    {PART_VBMETA,              932 * 1024,   4 * 1024,     EMMC_USER_PART}, /* PART_VBMETA     4M      p65 */
    {PART_MODEMNVM_UPDATE,     936 * 1024,  16 * 1024,     EMMC_USER_PART}, /* modemnvm_update   16M   p66 */
    {PART_MODEMNVM_CUST,       952 * 1024,  16 * 1024,     EMMC_USER_PART}, /* modemnvm_cust   16M     p67 */
    {PART_PATCH,               968 * 1024,  32 * 1024,     EMMC_USER_PART}, /* patch           32M     p68 */
    {PART_CACHE,              1000 * 1024, 104 * 1024,     EMMC_USER_PART}, /* cache           104M    p69 */
#ifdef CONFIG_FACTORY_MODE
    {PART_PREAS,              1104 * 1024,          136 * 1024,    EMMC_USER_PART}, /* preas          136M    p70 */
    {PART_PREAVS,             1240 * 1024,           32 * 1024,    EMMC_USER_PART}, /* preavs          32M    p71 */
    {PART_SUPER,              1272 * 1024,         7020 * 1024,    EMMC_USER_PART}, /* super         7020M    p72 */
    {PART_VERSION,            8292 * 1024,          576 * 1024,    EMMC_USER_PART}, /* version        576M    p73 */
    {PART_PRELOAD,            8868 * 1024,          900 * 1024,    EMMC_USER_PART}, /* preload        900M    p74 */
    {PART_HIBENCH_IMG,        9768 * 1024,          128 * 1024,    EMMC_USER_PART}, /* hibench_img    128M    p75 */
    {PART_HIBENCH_DATA,       9896 * 1024,          512 * 1024,    EMMC_USER_PART}, /* hibench_data   512M    p76 */
    {PART_FLASH_AGEING,      10408 * 1024,          512 * 1024,    EMMC_USER_PART}, /* flash_ageing   512M    p77 */
    {PART_HIBENCH_LOG,       10920 * 1024,           32 * 1024,    EMMC_USER_PART}, /* HIBENCH_LOG     32M    p78 */
    {PART_USERDATA,          10952 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata         4G    p79 */
#else
#ifdef CONFIG_USE_EROFS
#ifdef CONFIG_MARKET_INTERNAL
    {PART_PREAS,              1104 * 1024,          312 * 1024,    EMMC_USER_PART}, /* preas           312M    p70 */
    {PART_PREAVS,             1416 * 1024,           32 * 1024,    EMMC_USER_PART}, /* preavs           32M    p71 */
    {PART_SUPER,              1448 * 1024,         5064 * 1024,    EMMC_USER_PART}, /* super          5064M    p72 */
    {PART_VERSION,            6512 * 1024,           32 * 1024,    EMMC_USER_PART}, /* version          32M    p73 */
    {PART_PRELOAD,            6544 * 1024,          928 * 1024,    EMMC_USER_PART}, /* preload         928M    p74 */
    {PART_USERDATA,           7472 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata        4G      p75 */
#elif defined CONFIG_MARKET_OVERSEA
#ifdef CONFIG_16G_STORAGE
    {PART_PREAS,              1104 * 1024,          760 * 1024,    EMMC_USER_PART}, /* preas          1312M    p70 */
    {PART_PREAVS,             1864 * 1024,           32 * 1024,    EMMC_USER_PART}, /* preavs           32M    p71 */
    {PART_SUPER,              1896 * 1024,         3584 * 1024,    EMMC_USER_PART}, /* super          4344M    p72 */
    {PART_VERSION,            5480 * 1024,           32 * 1024,    EMMC_USER_PART}, /* version          32M    p73 */
    {PART_PRELOAD,            5512 * 1024,          600 * 1024,    EMMC_USER_PART}, /* preload         928M    p74 */
    {PART_USERDATA,           6112 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata        4G      p75 */
#else
    {PART_PREAS,              1104 * 1024,         1312 * 1024,    EMMC_USER_PART}, /* preas          1312M    p70 */
    {PART_PREAVS,             2416 * 1024,           32 * 1024,    EMMC_USER_PART}, /* preavs           32M    p71 */
    {PART_SUPER,              2448 * 1024,         4344 * 1024,    EMMC_USER_PART}, /* super          4344M    p72 */
    {PART_VERSION,            6792 * 1024,           32 * 1024,    EMMC_USER_PART}, /* version          32M    p73 */
    {PART_PRELOAD,            6824 * 1024,          928 * 1024,    EMMC_USER_PART}, /* preload         928M    p74 */
    {PART_USERDATA,           7752 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata        4G      p75 */
#endif
#else
    {PART_PREAS,              1104 * 1024,          136 * 1024,    EMMC_USER_PART}, /* preas           136M    p70 */
    {PART_PREAVS,             1240 * 1024,           32 * 1024,    EMMC_USER_PART}, /* preavs           32M    p71 */
    ...
    {PART_VERSION,            8292 * 1024,          576 * 1024,    EMMC_USER_PART}, /* version         576M    p73 */
    {PART_PRELOAD,            8868 * 1024,          900 * 1024,    EMMC_USER_PART}, /* preload         900M    p74 */
    {PART_USERDATA,           9768 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata       4G       p75 */
#endif /* internal */
#else /* not erofs, ext4 */
#ifdef CONFIG_MARKET_INTERNAL
    {PART_PREAS,              1104 * 1024,          136 * 1024,    EMMC_USER_PART}, /* preas           136M    p70 */
    {PART_PREAVS,             1240 * 1024,           32 * 1024,    EMMC_USER_PART}, /* preavs           32M    p71 */
    {PART_SUPER,              1272 * 1024,         4176 * 1024,    EMMC_USER_PART}, /* super          4176M    p72 */
    {PART_VERSION,            5448 * 1024,           32 * 1024,    EMMC_USER_PART}, /* version          32M    p73 */
    {PART_PRELOAD,            5480 * 1024,          928 * 1024,    EMMC_USER_PART}, /* preload         928M    p74 */
    {PART_USERDATA,           6408 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata        4G      p75 */
#elif defined CONFIG_MARKET_OVERSEA
    {PART_PREAS,              1104 * 1024,         1008 * 1024,    EMMC_USER_PART}, /* preas          1008M    p70 */
    {PART_PREAVS,             2112 * 1024,           32 * 1024,    EMMC_USER_PART}, /* preavs           32M    p71 */
    {PART_SUPER,              2144 * 1024,         3536 * 1024,    EMMC_USER_PART}, /* super          3536M    p72 */
    {PART_VERSION,            5680 * 1024,           32 * 1024,    EMMC_USER_PART}, /* version          32M    p73 */
    {PART_PRELOAD,            5712 * 1024,          928 * 1024,    EMMC_USER_PART}, /* preload         928M    p74 */
    {PART_USERDATA,           6640 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata        4G      p75 */
#else
    {PART_PREAS,              1104 * 1024,          136 * 1024,    EMMC_USER_PART}, /* preas           136M    p70 */
    {PART_PREAVS,             1240 * 1024,           32 * 1024,    EMMC_USER_PART}, /* preavs           32M    p71 */
    {PART_SUPER,              1272 * 1024,         7020 * 1024,    EMMC_USER_PART}, /* super          7020M    p72 */
...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_RESERVED8,           674 * 1024,  74 * 1024,    UFS_PART_3}, /* reserved8         78M    p47 */
#else
    {PART_ERECOVERY_RAMDISK,   450 * 1024,  32 * 1024,    UFS_PART_3}, /* erecovery_ramdisk 32M    p41 */
    ...
    {PART_RESERVED8,           658 * 1024,  90 * 1024,    UFS_PART_3}, /* reserved8         94M    p47 */
#endif
    ...
    {PART_RECOVERY_VENDOR,     796 * 1024,  16 * 1024,    UFS_PART_3}, /* recovery_vendor    16M    p51 */
    {PART_FW_DTB,              812 * 1024,   2 * 1024,    UFS_PART_3}, /* fw_dtb              2M    p52 */
    {PART_DTBO,                814 * 1024,  24 * 1024,    UFS_PART_3}, /* dtoimage           24M    p53 */
    {PART_TRUSTFIRMWARE,       838 * 1024,   2 * 1024,    UFS_PART_3}, /* trustfirmware       2M    p54 */
    {PART_MODEM_FW,            840 * 1024,  56 * 1024,    UFS_PART_3}, /* modem_fw           56M    p55 */
    {PART_ENG_VENDOR,          896 * 1024,  12 * 1024,    UFS_PART_3}, /* eng_vendor         12M    p56 */
    {PART_MODEM_PATCH_NV,      908 * 1024,   4 * 1024,    UFS_PART_3}, /* modem_patch_nv      4M    p57 */
    {PART_RESERVED4,           912 * 1024,   8 * 1024,    UFS_PART_3}, /* reserved4           8M    p58 */
    {PART_RECOVERY_VBMETA,     920 * 1024,   2 * 1024,    UFS_PART_3}, /* recovery_vbmeta     2M    p59 */
    {PART_ERECOVERY_VBMETA,    922 * 1024,   2 * 1024,    UFS_PART_3}, /* erecovery_vbmeta    2M    p60 */
    {PART_VBMETA,              924 * 1024,   4 * 1024,    UFS_PART_3}, /* PART_VBMETA         4M    p61 */
    {PART_MODEMNVM_UPDATE,     928 * 1024,  16 * 1024,    UFS_PART_3}, /* modemnvm_update    16M    p62 */
    {PART_MODEMNVM_CUST,       944 * 1024,  16 * 1024,    UFS_PART_3}, /* modemnvm_cust      16M    p63 */
    {PART_PATCH,               960 * 1024,  32 * 1024,    UFS_PART_3}, /* patch              32M    p64 */
    {PART_CACHE,               992 * 1024, 104 * 1024,    UFS_PART_3}, /* cache             104M    p65 */
#ifdef CONFIG_FACTORY_MODE
    {PART_PREAS,              1096 * 1024,          136 * 1024,    UFS_PART_3}, /* preas           136M    p66 */
    {PART_PREAVS,             1232 * 1024,           32 * 1024,    UFS_PART_3}, /* preavs           32M    p67 */
    {PART_SUPER,              1264 * 1024,         7020 * 1024,    UFS_PART_3}, /* super          7020M    p68 */
    {PART_VERSION,            8284 * 1024,          576 * 1024,    UFS_PART_3}, /* version         576M    p69 */
    {PART_PRELOAD,            8860 * 1024,          900 * 1024,    UFS_PART_3}, /* preload         900M    p70 */
    {PART_HIBENCH_IMG,        9760 * 1024,          128 * 1024,    UFS_PART_3}, /* hibench_img     128M    p71 */
    {PART_HIBENCH_DATA,       9888 * 1024,          512 * 1024,    UFS_PART_3}, /* hibench_data    512M    p72 */
    {PART_FLASH_AGEING,      10400 * 1024,          512 * 1024,    UFS_PART_3}, /* flash_ageing    512M    p73 */
    {PART_HIBENCH_LOG,       10912 * 1024,           32 * 1024,    UFS_PART_3}, /* HIBENCH_LOG      32M    p74 */
    {PART_USERDATA,          10944 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata          4G    p75 */
#else /* factory */
#ifdef CONFIG_USE_EROFS
#ifdef CONFIG_MARKET_INTERNAL
    {PART_PREAS,              1096 * 1024,          312 * 1024,    UFS_PART_3}, /* preas           312M    p66 */
    {PART_PREAVS,             1408 * 1024,           32 * 1024,    UFS_PART_3}, /* preavs           32M    p67 */
    {PART_SUPER,              1440 * 1024,         5064 * 1024,    UFS_PART_3}, /* super          5064M    p68 */
    {PART_VERSION,            6504 * 1024,           32 * 1024,    UFS_PART_3}, /* version          32M    p69 */
    {PART_PRELOAD,            6536 * 1024,          928 * 1024,    UFS_PART_3}, /* preload         928M    p70 */
    {PART_USERDATA,           7464 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata        4G      p71 */
#elif defined CONFIG_MARKET_OVERSEA
    {PART_PREAS,              1096 * 1024,         1312 * 1024,    UFS_PART_3}, /* preas          1312M    p66 */
    {PART_PREAVS,             2408 * 1024,           32 * 1024,    UFS_PART_3}, /* preavs           32M    p67 */
    {PART_SUPER,              2440 * 1024,         4344 * 1024,    UFS_PART_3}, /* super          4344M    p68 */
    {PART_VERSION,            6784 * 1024,           32 * 1024,    UFS_PART_3}, /* version          32M    p69 */
    {PART_PRELOAD,            6816 * 1024,          928 * 1024,    UFS_PART_3}, /* preload         928M    p70 */
    {PART_USERDATA,           7744 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata        4G      p71 */
#else
    {PART_PREAS,              1096 * 1024,          136 * 1024,    UFS_PART_3}, /* preas           136M    p66 */
    {PART_PREAVS,             1232 * 1024,           32 * 1024,    UFS_PART_3}, /* preavs           32M    p67 */
    {PART_SUPER,              1264 * 1024,         7020 * 1024,    UFS_PART_3}, /* super          7020M    p68 */
    {PART_VERSION,            8284 * 1024,          576 * 1024,    UFS_PART_3}, /* version         576M    p69 */
    {PART_PRELOAD,            8860 * 1024,          900 * 1024,    UFS_PART_3}, /* preload         900M    p70 */
    {PART_USERDATA,           9760 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata          4G    p71 */
#endif /* internal */
#else /* not erofs, ext4 */
#ifdef CONFIG_MARKET_INTERNAL
    {PART_PREAS,              1096 * 1024,          136 * 1024,    UFS_PART_3}, /* preas           136M    p66 */
    {PART_PREAVS,             1232 * 1024,           32 * 1024,    UFS_PART_3}, /* preavs           32M    p67 */
    {PART_SUPER,              1264 * 1024,         4176 * 1024,    UFS_PART_3}, /* super          4176M    p68 */
    {PART_VERSION,            5440 * 1024,           32 * 1024,    UFS_PART_3}, /* version          32M    p69 */
    {PART_PRELOAD,            5472 * 1024,          928 * 1024,    UFS_PART_3}, /* preload         928M    p70 */
    {PART_USERDATA,           6400 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata        4G      p71 */
#elif defined CONFIG_MARKET_OVERSEA
    {PART_PREAS,              1096 * 1024,         1008 * 1024,    UFS_PART_3}, /* preas          1008M    p66 */
    {PART_PREAVS,             2104 * 1024,           32 * 1024,    UFS_PART_3}, /* preavs           32M    p67 */
    {PART_SUPER,              2136 * 1024,         3536 * 1024,    UFS_PART_3}, /* super          3536M    p68 */
    {PART_VERSION,            5672 * 1024,           32 * 1024,    UFS_PART_3}, /* version          32M    p69 */
    {PART_PRELOAD,            5704 * 1024,          928 * 1024,    UFS_PART_3}, /* preload         928M    p70 */
    {PART_USERDATA,           6632 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata        4G      p71 */
#else
    {PART_PREAS,              1096 * 1024,          136 * 1024,    UFS_PART_3}, /* preas           136M    p66 */
    {PART_PREAVS,             1232 * 1024,           32 * 1024,    UFS_PART_3}, /* preavs           32M    p67 */
    {PART_SUPER,              1264 * 1024,         7020 * 1024,    UFS_PART_3}, /* super          7020M    p68 */
