...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_THSP,                   835 * 1024,   12 * 1024,    EMMC_USER_PART}, /* thsp              12M    p55 */
    ...
    {PART_MODEMNVM_CUST,         1133 * 1024,   16 * 1024,    EMMC_USER_PART}, /* modemnvm_cust     16M    p68 */
    {PART_RAMDISK,               1149 * 1024,    2 * 1024,    EMMC_USER_PART}, /* ramdisk            2M    p69 */
    ...
    {PART_PREAS,                 1200 * 1024,  368 * 1024,    EMMC_USER_PART}, /* preas            368M    p80 */
    {PART_PREAVS,                1568 * 1024,   32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p81 */
    {PART_SUPER,                 1600 * 1024, 9168 * 1024,    EMMC_USER_PART}, /* super           9168M    p82 */
    {PART_VERSION,              10768 * 1024,  576 * 1024,    EMMC_USER_PART}, /* version          576M    p83 */
    {PART_PRELOAD,              11344 * 1024, 1144 * 1024,    EMMC_USER_PART}, /* preload         1144M    p84 */
    {PART_HIBENCH_IMG,          12488 * 1024,  128 * 1024,    EMMC_USER_PART}, /* hibench_img      128M    p85 */
    {PART_HIBENCH_DATA,         12616 * 1024,  512 * 1024,    EMMC_USER_PART}, /* hibench_data     512M    p86 */
    {PART_FLASH_AGEING,         13128 * 1024,  512 * 1024,    EMMC_USER_PART}, /* FLASH_AGEING     512M    p87 */
    {PART_HIBENCH_LOG,          13640 * 1024,   32 * 1024,    EMMC_USER_PART}, /* HIBENCH_LOG       32M    p88 */
    {PART_USERDATA,             13672 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata   4G    p89 */
    ...
    {PART_VERSION,              10768 * 1024,  576 * 1024,    EMMC_USER_PART}, /* version          576M    p83 */
    {PART_PRELOAD,              11344 * 1024, 1144 * 1024,    EMMC_USER_PART}, /* preload         1144M    p84 */
    {PART_USERDATA,             12488 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata   4G    p85 */
#else
    {PART_PREAS,                 1200 * 1024, 1280 * 1024,    EMMC_USER_PART}, /* preas           1280M    p80 */
    {PART_PREAVS,                2480 * 1024,   32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p81 */
    {PART_SUPER,                 2512 * 1024, 9384 * 1024,    EMMC_USER_PART}, /* super           9384M    p82 */
    {PART_VERSION,              11896 * 1024,  576 * 1024,    EMMC_USER_PART}, /* version          576M    p83 */
    {PART_PRELOAD,              12472 * 1024, 1144 * 1024,    EMMC_USER_PART}, /* preload         1144M    p84 */
    {PART_USERDATA,             13616 * 1024, (4UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata   4G    p85 */
#endif
    {"0", 0, 0, 0},
};
...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_THSP,                   827 * 1024,    12 * 1024,    UFS_PART_3}, /* thsp              12M    p51 */
...
#ifdef CONFIG_FACTORY_MODE
    {PART_PREAS,                 1192 * 1024,   368 * 1024,    UFS_PART_3}, /* preas            368M    p76 */
    {PART_PREAVS,                1560 * 1024,    32 * 1024,    UFS_PART_3}, /* preavs            32M    p77 */
    {PART_SUPER,                 1592 * 1024,  9168 * 1024,    UFS_PART_3}, /* super           9168M    p78 */
    {PART_VERSION,              10760 * 1024,   576 * 1024,    UFS_PART_3}, /* version          576M    p79 */
    {PART_PRELOAD,              11336 * 1024,  1144 * 1024,    UFS_PART_3}, /* preload         1144M    p80 */
    {PART_HIBENCH_IMG,          12480 * 1024,   128 * 1024,    UFS_PART_3}, /* hibench_img      128M    p81 */
    {PART_HIBENCH_DATA,         12608 * 1024,   512 * 1024,    UFS_PART_3}, /* hibench_data     512M    p82 */
    {PART_FLASH_AGEING,         13120 * 1024,   512 * 1024,    UFS_PART_3}, /* FLASH_AGEING     512M    p83 */
    {PART_HIBENCH_LOG,          13632 * 1024,    32 * 1024,    UFS_PART_3}, /* HIBENCH_LOG       32M    p84 */
    {PART_USERDATA,             13664 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata    4G    p85 */
#elif defined CONFIG_MARKET_INTERNAL
    {PART_PREAS,                 1192 * 1024,   368 * 1024,    UFS_PART_3}, /* preas            368M    p76 */
    {PART_PREAVS,                1560 * 1024,    32 * 1024,    UFS_PART_3}, /* preavs            32M    p77 */
    {PART_SUPER,                 1592 * 1024,  9168 * 1024,    UFS_PART_3}, /* super           9168M    p78 */
    {PART_VERSION,              10760 * 1024,   576 * 1024,    UFS_PART_3}, /* version          576M    p79 */
    {PART_PRELOAD,              11336 * 1024,  1144 * 1024,    UFS_PART_3}, /* preload         1144M    p80 */
    {PART_USERDATA,             12480 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata    4G    p81 */
#else
    {PART_PREAS,                 1192 * 1024,  1280 * 1024,    UFS_PART_3}, /* preas           1280M    p76 */
    {PART_PREAVS,                2472 * 1024,    32 * 1024,    UFS_PART_3}, /* preavs            32M    p77 */
    {PART_SUPER,                 2504 * 1024,  9384 * 1024,    UFS_PART_3}, /* super           9384M    p78 */
    {PART_VERSION,              11888 * 1024,   576 * 1024,    UFS_PART_3}, /* version          576M    p79 */
    {PART_PRELOAD,              12464 * 1024,  1144 * 1024,    UFS_PART_3}, /* preload         1144M    p80 */
    {PART_USERDATA,             13608 * 1024, (4UL) * 1024 * 1024,    UFS_PART_3}, /* userdata    4G    p81 */
#endif
