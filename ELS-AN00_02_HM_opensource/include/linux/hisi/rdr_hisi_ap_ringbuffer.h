...
static inline void hisiap_ringbuffer_write(struct hisiap_ringbuffer_s *q, u8 *element)
{
	return;
}

static inline int  hisiap_ringbuffer_read(struct hisiap_ringbuffer_s *q, u8 *element, u32 len)
{
	return 0;
}

static inline int  hisiap_is_ringbuffer_full(const void *buffer_addr)
{
	return 0;
}

static inline void get_ringbuffer_start_end(struct hisiap_ringbuffer_s *q, u32 *start, u32 *end)
{
	return;
}

static inline bool is_ringbuffer_empty(struct hisiap_ringbuffer_s *q)
{
	return true;
}

static inline bool is_ringbuffer_invalid(u32 field_count, u32 len, struct hisiap_ringbuffer_s *q)
{
	return true;
}
#endif
