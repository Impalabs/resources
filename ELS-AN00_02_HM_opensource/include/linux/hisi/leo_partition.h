...
static const struct partition partition_table_emmc[] =
{
  ...
  {PART_USERDATA,                13992*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p76*/
    ...
    {PART_PATCH,                1168 * 1024,         96 * 1024,    EMMC_USER_PART}, /* patch             96M    p69 */
    {PART_METADATA,             1264 * 1024,         16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p70 */
    {PART_PREAS,                1280 * 1024,        360 * 1024,    EMMC_USER_PART}, /* preas            360M    p71 */
    {PART_PREAVS,               1640 * 1024,         32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p72 */
    {PART_SUPER,                1672 * 1024,       6056 * 1024,    EMMC_USER_PART}, /* super           6056M    p73 */
  ...
  {PART_USERDATA,                 8904*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p76*/
    ...
    {PART_PATCH,                1168 * 1024,         96 * 1024,    EMMC_USER_PART}, /* patch             96M    p69 */
    {PART_METADATA,             1264 * 1024,         16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p70 */
    {PART_PREAS,                1280 * 1024,       1568 * 1024,    EMMC_USER_PART}, /* preas           1568M    p71 */
    {PART_PREAVS,               2848 * 1024,         32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p72 */
    {PART_SUPER,                2880 * 1024,       5376 * 1024,    EMMC_USER_PART}, /* super           5376M    p73 */
  ...
  {PART_USERDATA,                 9432*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p76*/
    ...
    {PART_PATCH,                1168 * 1024,         96 * 1024,    EMMC_USER_PART}, /* patch             96M    p69 */
    {PART_METADATA,             1264 * 1024,         16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p70 */
    {PART_PREAS,                1280 * 1024,        296 * 1024,    EMMC_USER_PART}, /* preas            296M    p71 */
    {PART_PREAVS,               1576 * 1024,         32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p72 */
    {PART_SUPER,                1608 * 1024,       6392 * 1024,    EMMC_USER_PART}, /* super           6392M    p73 */
  ...
  {PART_USERDATA,                10080*1024, (4UL)*1024*1024,    EMMC_USER_PART},/* userdata           4G    p76*/
    ...
    {PART_PATCH,                1168 * 1024,         96 * 1024,    EMMC_USER_PART}, /* patch             96M    p69 */
    {PART_METADATA,             1264 * 1024,         16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p70 */
    {PART_PREAS,                1280 * 1024,       1024 * 1024,    EMMC_USER_PART}, /* preas            976M    p71 */
    {PART_PREAVS,               2304 * 1024,         32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p72 */
    {PART_SUPER,                2336 * 1024,       6368 * 1024,    EMMC_USER_PART}, /* super           6368M    p73 */
...
static const struct partition partition_table_ufs[] =
{
...
#ifdef CONFIG_USE_EROFS
  #ifdef CONFIG_MARKET_INTERNAL
    {PART_PATCH,                    1160 * 1024,         96 * 1024,    UFS_PART_3}, /* patch             96M    p65 */
    {PART_METADATA,                 1256 * 1024,         16 * 1024,    UFS_PART_3}, /* metadata          16M    p66 */
    {PART_PREAS,                    1272 * 1024,        360 * 1024,    UFS_PART_3}, /* preas            360M    p67 */
    {PART_PREAVS,                   1632 * 1024,         32 * 1024,    UFS_PART_3}, /* preavs            32M    p68 */
    {PART_SUPER,                    1664 * 1024,       6056 * 1024,    UFS_PART_3}, /* super           6056M    p69 */
  ...
  {PART_USERDATA,                 8896*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata           4G    p72*/
    ...
    {PART_PATCH,                    1160 * 1024,         96 * 1024,    UFS_PART_3}, /* patch             96M    p65 */
    {PART_METADATA,                 1256 * 1024,         16 * 1024,    UFS_PART_3}, /* metadata          16M    p66 */
    {PART_PREAS,                    1272 * 1024,       1568 * 1024,    UFS_PART_3}, /* preas           1568M    p67 */
    {PART_PREAVS,                   2840 * 1024,         32 * 1024,    UFS_PART_3}, /* preavs            32M    p68 */
    {PART_SUPER,                    2872 * 1024,       5376 * 1024,    UFS_PART_3}, /* super           5376M    p69 */
  ...
  {PART_USERDATA,                 9424*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata           4G    p72*/
    ...
    {PART_PATCH,                    1160 * 1024,         96 * 1024,    UFS_PART_3}, /* patch             96M    p65 */
    {PART_METADATA,                 1256 * 1024,         16 * 1024,    UFS_PART_3}, /* metadata          16M    p66 */
    {PART_PREAS,                    1272 * 1024,        296 * 1024,    UFS_PART_3}, /* preas            296M    p67 */
    {PART_PREAVS,                   1568 * 1024,         32 * 1024,    UFS_PART_3}, /* preavs            32M    p68 */
    {PART_SUPER,                    1600 * 1024,       6392 * 1024,    UFS_PART_3}, /* super           6392M    p69 */
  ...
  {PART_USERDATA,                10072*1024, (4UL)*1024*1024,    UFS_PART_3},/* userdata           4G    p72*/
    ...
    {PART_PATCH,                    1160 * 1024,         96 * 1024,    UFS_PART_3}, /* patch             96M    p65 */
    {PART_METADATA,                 1256 * 1024,         16 * 1024,    UFS_PART_3}, /* metadata          16M    p66 */
    {PART_PREAS,                    1272 * 1024,       1024 * 1024,    UFS_PART_3}, /* preas           1024M    p67 */
    {PART_PREAVS,                   2296 * 1024,         32 * 1024,    UFS_PART_3}, /* preavs            32M    p68 */
    {PART_SUPER,                    2328 * 1024,       6368 * 1024,    UFS_PART_3}, /* super           6368M    p69 */
