 ...
 * Description: USB ACM modem function Interface
 * Create: 2013
 *
...
/* Asynchronous data transceiving structure */
...
typedef enum tagACM_EVT_E {
	ACM_EVT_DEV_SUSPEND = 0,        /* The device cannot be read or written */
	ACM_EVT_DEV_READY = 1,          /* The device can be read and written */
	ACM_EVT_DEV_BOTTOM
} ACM_EVT_E;
