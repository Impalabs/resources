...
#define MPTCP_PROXY_FLAG_SYN_FALLBACK 1
...
/* This is needed to ensure that two subsequent key/non#ce-generation result in
...
{\
	(conf_type) = (1 << (((uint32_t)cmd_input) & 0xFFFFFF));\
}
